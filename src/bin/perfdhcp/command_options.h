...
public:
    ...
    bool loadRepliesFromFile() const { return load_replies_from_file_; }

    bool saveRepliesToFile() const { return save_replies_to_file_; }

    bool renewOnly() const { return renew_only_; }

    int requestCountForRenews() const { return request_count_for_renews_; }
...
private:
    ...
    int request_count_for_renews_;

    bool load_replies_from_file_;

    bool save_replies_to_file_;
};

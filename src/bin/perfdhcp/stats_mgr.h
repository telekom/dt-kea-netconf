...
typedef typename std::shared_ptr<CustomCounter> CustomCounterPtr;
...
public:
    ...
    /// std::shared_ptr<Pkt4> pkt1(new Pkt4(...));
    /// std::shared_ptr<Pkt4> pkt2(new Pkt4(...));
...
typedef std::shared_ptr<ExchangeStats> ExchangeStatsPtr;
...
typedef std::shared_ptr<StatsMgr> StatsMgrPtr;

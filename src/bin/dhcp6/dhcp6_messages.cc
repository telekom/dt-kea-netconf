// File created from ../../../src/bin/dhcp6/dhcp6_messages.mes on Mon Aug 17 2020 17:11
...
extern const isc::log::MessageID DHCP6_ERROR = "DHCP6_ERROR";
extern const isc::log::MessageID DHCP6_FLEX_ID = "DHCP6_FLEX_ID";
extern const isc::log::MessageID DHCP6_FORCE_RELOAD_CONFIGURATION = "DHCP6_FORCE_RELOAD_CONFIGURATION";
...
extern const isc::log::MessageID DHCP6_INFO = "DHCP6_INFO";
...
extern const isc::log::MessageID DHCP6_MASTER_CONFIGURATION_CHANGED = "DHCP6_MASTER_CONFIGURATION_CHANGED";
...
extern const isc::log::MessageID DHCP6_SHARD_CONFIGURATION_CHANGED = "DHCP6_SHARD_CONFIGURATION_CHANGED";
...
extern const isc::log::MessageID DHCP6_TRANSACTION_FAILED = "DHCP6_TRANSACTION_FAILED";
...
extern const isc::log::MessageID DHCP6_WARNING = "DHCP6_WARNING";
...
const char* values[] = {
    ...
    "DHCP6_BUFFER_UNPACK", "parsing buffer received from %1 to %2 over interface %3, localAddr=[%2], remoteAddr=[%1]",
    ...
    "DHCP6_DHCP4O6_PACKET_RECEIVED", "received DHCPv4o6 packet from DHCPv4 server (type %1), msgtype=%1, for %2 port %3 on interface %4",
    ...
    "DHCP6_FORCE_RELOAD_CONFIGURATION", "DHCPv6 force configuration reload.",
    ...
    "DHCP6_MASTER_CONFIGURATION_CHANGED", "DHCPv6 master configuration is different.",
    ...
    "DHCP6_PACKET_PROCESS_FAIL", "processing of %1 message, msgtype=%1, received from %2 failed: %3, remoteAddr=[%2]",
    ...
    "DHCP6_PACKET_RECEIVED", "%1: %2 (type %3), msgtype=%3, received from %4 to %5 on interface %6, localAddr=[%5], remoteAddr=[%4]",
    ...
    "DHCP6_REQUIRED_OPTIONS_CHECK_FAIL", "%1 message received from %2 failed the following check: %3, remoteAddr=[%2]",
    "DHCP6_RESPONSE_DATA", "responding with packet type %1 data is %2",
    "DHCP6_SERVER_FAILED", "server failed: %1",
    "DHCP6_SHARD_CONFIGURATION_CHANGED", "DHCPv6 shard configuration is different.",
    ...
    "DHCP6_TRANSACTION_FAILED", "transaction failed. error: %1",
    "DHCP6_UNKNOWN_MSG_RECEIVED", "received unknown message (type %1), msgtype=%1, on interface %2",

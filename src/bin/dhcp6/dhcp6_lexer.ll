...
\"library-path\" {
    switch(driver.ctx_) {
    case isc::dhcp::Parser6Context::HOOKS_LIBRARIES:
        return isc::dhcp::Dhcp6Parser::make_LIBRARY_PATH(driver.loc_);
    default:
        return isc::dhcp::Dhcp6Parser::make_STRING("library-path", driver.loc_);
    }
}
...
\"on-boot-request-configuration-from-kea-netconf\" {
    switch(driver.ctx_) {
    case isc::dhcp::Parser6Context::CONTROL_SOCKET:
        return isc::dhcp::Dhcp6Parser::make_ON_BOOT_REQUEST_CONFIGURATION_FROM_KEA_NETCONF(driver.loc_);
    default:
        return isc::dhcp::Dhcp6Parser::make_STRING("on-boot-request-configuration-from-kea-netconf", driver.loc_);
    }
}
...
\"allocation-type\" {
    switch(driver.ctx_) {
    case isc::dhcp::Parser6Context::SUBNET6:
        return isc::dhcp::Dhcp6Parser::make_ALLOCATION_TYPE(driver.loc_);
    default:
        return isc::dhcp::Dhcp6Parser::make_STRING("allocation-type", driver.loc_);
    }
}
...
\"lawful-interception-parameters\" {
    ...
    case isc::dhcp::Parser6Context::HOOKS_LIBRARIES:
        return isc::dhcp::Dhcp6Parser::make_PARAMETERS(driver.loc_);
    default:
        return isc::dhcp::Dhcp6Parser::make_STRING("lawful-interception-parameters", driver.loc_);
    }
}
...
\"max-address-utilization\" {
    switch(driver.ctx_) {
    case isc::dhcp::Parser6Context::POOLS:
        return isc::dhcp::Dhcp6Parser::make_MAX_ADDRESS_UTILIZATION(driver.loc_);
    default:
        return isc::dhcp::Dhcp6Parser::make_STRING("max-address-utilization", driver.loc_);
    }
}
...
\"max-pd-space-utilization\" {
    switch(driver.ctx_) {
    case isc::dhcp::Parser6Context::POOLS:
        return isc::dhcp::Dhcp6Parser::make_MAX_PD_SPACE_UTILIZATION(driver.loc_);
    default:
        return isc::dhcp::Dhcp6Parser::make_STRING("max-pd-space-utilization", driver.loc_);
    }
}
...
\"max-statement-tries\" {
    ...
    case isc::dhcp::Parser6Context::CONFIG_DATABASE:
    case isc::dhcp::Parser6Context::MASTER_DATABASE:
        return isc::dhcp::Dhcp6Parser::make_MAX_STATEMENT_TRIES(driver.loc_);
    default:
        return isc::dhcp::Dhcp6Parser::make_STRING("max-statement-tries", driver.loc_);
    }
}
...
\"notifications\" {
    switch(driver.ctx_) {
    case isc::dhcp::Parser6Context::DHCP6:
        return isc::dhcp::Dhcp6Parser::make_NOTIFICATIONS(driver.loc_);
    default:
        return isc::dhcp::Dhcp6Parser::make_STRING("notifications", driver.loc_);
    }
}
...
\"policy-engine-parameters\" {
    ...
    case isc::dhcp::Parser6Context::HOOKS_LIBRARIES:
        return isc::dhcp::Dhcp6Parser::make_PARAMETERS(driver.loc_);
    default:
        return isc::dhcp::Dhcp6Parser::make_STRING("policy-engine-parameters", driver.loc_);
    }
}

\"privacy-history-size\" {
    switch(driver.ctx_) {
    case isc::dhcp::Parser6Context::DHCP6:
        return isc::dhcp::Dhcp6Parser::make_PRIVACY_HISTORY_SIZE(driver.loc_);
    default:
        return isc::dhcp::Dhcp6Parser::make_STRING("privacy-history-size", driver.loc_);
    }
}

\"privacy-valid-lifetime\" {
    switch(driver.ctx_) {
    case isc::dhcp::Parser6Context::DHCP6:
        return isc::dhcp::Dhcp6Parser::make_PRIVACY_VALID_LIFETIME(driver.loc_);
    default:
        return isc::dhcp::Dhcp6Parser::make_STRING("privacy-valid-lifetime", driver.loc_);
    }
}

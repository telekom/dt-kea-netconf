...
public:
    ...
    void verifyConfig0Options(const Dhcp6Client::Configuration& config,
        ...
        // DNS servers.
        Option6AddrLstPtr dns_servers_opt = std::dynamic_pointer_cast<
        ...
        // NIS servers.
        Option6AddrLstPtr nis_servers_opt = std::dynamic_pointer_cast<
...
TEST_F(ClassifyTest, clientClassifyPoolKnown) {
    ...
    std::shared_ptr<Option6IAAddr> addr1 =
        std::dynamic_pointer_cast<Option6IAAddr>(iaaddr1);
    ASSERT_TRUE(addr1);
    ...
    ASSERT_TRUE(iaaddr2);
    std::shared_ptr<Option6IAAddr> addr2 =
        std::dynamic_pointer_cast<Option6IAAddr>(iaaddr2);
    ASSERT_TRUE(addr2);
...
TEST_F(ClassifyTest, member) {
    ...
    OptionCustomPtr ipf1 =
        std::dynamic_pointer_cast<OptionCustom>(opt1);
    ASSERT_TRUE(ipf1);
    ...
    OptionCustomPtr ipf3 =
        std::dynamic_pointer_cast<OptionCustom>(opt3);
    ASSERT_TRUE(ipf3);
...
TEST_F(ClassifyTest, precedencePool) {
    ...
    Option6AddrLstPtr servers =
        std::dynamic_pointer_cast<Option6AddrLst>(opt);
    ASSERT_TRUE(servers);

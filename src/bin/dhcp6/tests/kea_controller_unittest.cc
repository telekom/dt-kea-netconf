...
typedef std::shared_ptr<TestCBControlDHCPv6> TestCBControlDHCPv6Ptr;
...
public:
    ...
    void testConfigBackendTimer(const int config_wait_fetch_time,
        ...
        std::unique_ptr<NakedControlledDhcpv6Srv> srv;
        ...
        auto cb_control = std::dynamic_pointer_cast<TestCBControlDHCPv6>(srv->getCBControl());

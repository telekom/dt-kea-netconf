...
public:
    ...
    Option6ClientFqdnPtr getClientFqdnOption(const Pkt6Ptr& pkt) {
        return (std::dynamic_pointer_cast<Option6ClientFqdn>
    ...
    void testFqdn(const uint16_t msg_type,
        ...
        Option6ClientFqdnPtr answ_fqdn = std::dynamic_pointer_cast<
    ...
    void testProcessMessage(const uint8_t msg_type,
        ...
        ASSERT_TRUE(fqdn = std::dynamic_pointer_cast<
    ...
    void setSubnetAndPool(int subnet_idx, int pool_idx, Lease::Type type) {
        ...
        ASSERT_TRUE(pool);
        pool_ = std::dynamic_pointer_cast<Pool6>(pool);
        ASSERT_TRUE(pool);
    }
...
TEST_F(FqdnDhcpv6SrvTest, ddnsScopeTest) {
    ...
    Option6ClientFqdnPtr fqdn;
    fqdn = std::dynamic_pointer_cast<Option6ClientFqdn>(resp->getOption(D6O_CLIENT_FQDN));
    ASSERT_TRUE(fqdn);

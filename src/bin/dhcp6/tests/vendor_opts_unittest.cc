...
TEST_F(VendorOptsTest, docsisVendorORO) {
    ...
    OptionUint16ArrayPtr oro = std::dynamic_pointer_cast<OptionUint16Array>(opt);
    EXPECT_TRUE(oro);
}
...
TEST_F(VendorOptsTest, vendorOptionsORO) {
    ...
    std::shared_ptr<OptionUint16Array> vendor_oro(new OptionUint16Array(Option::V6,
                                                                          DOCSIS3_V6_ORO));
    ...
    OptionStringPtr config_file = std::dynamic_pointer_cast<OptionString>(docsis33);
...
TEST_F(VendorOptsTest, vendorOpsInResponseOnly) {
    ...
    OptionVendorPtr rsp_vopts = std::dynamic_pointer_cast<OptionVendor>(rsp);

...
TEST_F(InfRequestTest, infRequestBasic) {
    ...
    Option6AddrLstPtr dns = std::dynamic_pointer_cast<Option6AddrLst>
...
TEST_F(InfRequestTest, infRequestStateless) {
    ...
    Option6AddrLstPtr sip = std::dynamic_pointer_cast<Option6AddrLst>
...
TEST_F(InfRequestTest, infRequestNoSubnets) {
    ...
    // Check that we received the requested sip servers option
    Option6AddrLstPtr nis = std::dynamic_pointer_cast<Option6AddrLst>

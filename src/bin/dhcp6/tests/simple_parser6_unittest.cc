...
public:
    ...
    /// @param param_name name of the parameter to be checked
    /// @param exp_value expected value of the parameter.
    void checkStringValue(const ElementPtr& map, const std::string& param_name,
    ...
    /// @param param_name name of the parameter to be checked
    /// @param exp_value expected value of the parameter.
    void checkBoolValue(const ElementPtr& map, const std::string& param_name,
                        bool exp_value) {
    ...
    /// @param param_name name of the parameter to be checked
    /// @param exp_value expected value of the parameter.
    void checkDoubleValue(const ElementPtr& map, const std::string& param_name,
                        double exp_value) {
    ...
    /// @param map map to be checked
    /// @param param_name name of the parameter to be checked
    void checkNoValue(const ElementPtr& map, const std::string& param_name) {
        // First check if the passed element is a map.
        ASSERT_EQ(Element::map, map->getType());
...
TEST_F(SimpleParser6Test, inheritGlobalToSubnet6) {
    ...
    ElementPtr subnets = global->find("subnet6");
    ASSERT_TRUE(subnets);
    ElementPtr subnet = subnets->get(0);
    ASSERT_TRUE(subnet);
...
TEST_F(SimpleParser6Test, optionDataDefaults6) {
    ...
    ElementPtr options = global->find("option-data");
    ASSERT_TRUE(options);
...
TEST_F(SimpleParser6Test, optionDefDefaults6) {
    ...
    ElementPtr defs = global->find("option-def");
    ASSERT_TRUE(defs);
    ASSERT_EQ(1, defs->size());
    ElementPtr def = defs->get(0);
    ASSERT_TRUE(def);

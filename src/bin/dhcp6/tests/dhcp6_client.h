...
public:
    ...
    Dhcp6Client(std::shared_ptr<isc::dhcp::test::NakedDhcpv6Srv>& srv);
    ...
    std::shared_ptr<isc::dhcp::test::NakedDhcpv6Srv>& getServer() {
        return (srv_);
    }
...
private:
    ...
    std::shared_ptr<isc::dhcp::test::NakedDhcpv6Srv> srv_;

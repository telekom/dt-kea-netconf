  ...
  private:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOKEN_LIBRARY = 374,
        TOKEN_LIBRARY_PATH = 375,
        TOKEN_PARAMETERS = 376,
        TOKEN_EXPIRED_LEASES_PROCESSING = 377,
        TOKEN_RECLAIM_TIMER_WAIT_TIME = 378,
        TOKEN_FLUSH_RECLAIMED_TIMER_WAIT_TIME = 379,
        TOKEN_HOLD_RECLAIMED_TIME = 380,
        TOKEN_MAX_RECLAIM_LEASES = 381,
        TOKEN_MAX_RECLAIM_TIME = 382,
        TOKEN_UNWARNED_RECLAIM_CYCLES = 383,
        TOKEN_SERVER_ID = 384,
        TOKEN_LLT = 385,
        TOKEN_EN = 386,
        TOKEN_LL = 387,
        TOKEN_IDENTIFIER = 388,
        TOKEN_HTYPE = 389,
        TOKEN_TIME = 390,
        TOKEN_ENTERPRISE_ID = 391,
        TOKEN_DHCP4O6_PORT = 392,
        TOKEN_DHCP_MULTI_THREADING = 393,
        TOKEN_ENABLE_MULTI_THREADING = 394,
        TOKEN_THREAD_POOL_SIZE = 395,
        TOKEN_PACKET_QUEUE_SIZE = 396,
        TOKEN_CONTROL_SOCKET = 397,
        TOKEN_SOCKET_TYPE = 398,
        TOKEN_SOCKET_NAME = 399,
        TOKEN_DHCP_QUEUE_CONTROL = 400,
        TOKEN_ENABLE_QUEUE = 401,
        TOKEN_QUEUE_TYPE = 402,
        TOKEN_CAPACITY = 403,
        TOKEN_DHCP_DDNS = 404,
        TOKEN_ENABLE_UPDATES = 405,
        TOKEN_QUALIFYING_SUFFIX = 406,
        TOKEN_SERVER_IP = 407,
        TOKEN_SERVER_PORT = 408,
        TOKEN_SENDER_IP = 409,
        TOKEN_SENDER_PORT = 410,
        TOKEN_MAX_QUEUE_SIZE = 411,
        TOKEN_NCR_PROTOCOL = 412,
        TOKEN_NCR_FORMAT = 413,
        TOKEN_OVERRIDE_NO_UPDATE = 414,
        TOKEN_OVERRIDE_CLIENT_UPDATE = 415,
        TOKEN_REPLACE_CLIENT_NAME = 416,
        TOKEN_GENERATED_PREFIX = 417,
        TOKEN_UDP = 418,
        TOKEN_TCP = 419,
        TOKEN_JSON = 420,
        ...
        TOKEN_MAXVER = 434,
        TOKEN_PATTERN = 435,
        TOKEN_ALLOCATION_TYPE = 436,
        TOKEN_CONFIG_DATABASE = 437,
        TOKEN_CONFIGURATION_TYPE = 438,
        TOKEN_INSTANCE_ID = 439,
        TOKEN_LAWFUL_INTERCEPTION_PARAMETERS = 440,
        TOKEN_MASTER_DATABASE = 441,
        TOKEN_MAX_ADDRESS_UTILIZATION = 442,
        TOKEN_MAX_PD_SPACE_UTILIZATION = 443,
        TOKEN_MAX_STATEMENT_TRIES = 444,
        TOKEN_NOTIFICATIONS = 445,
        TOKEN_ON_BOOT_REQUEST_CONFIGURATION_FROM_KEA_NETCONF = 446,
        TOKEN_OPTION_SET_DESCRIPTION = 447,
        TOKEN_OPTION_SET_ID = 448,
        TOKEN_POLICY_ENGINE_PARAMETERS = 449,
        TOKEN_PRIVACY_HISTORY_SIZE = 450,
        TOKEN_PRIVACY_VALID_LIFETIME = 451,
        TOKEN_PROTOCOL = 452,
        TOKEN_SSL_CERT = 453,
        TOKEN_TOPLEVEL_JSON = 454,
        TOKEN_TOPLEVEL_DHCP6 = 455,
        TOKEN_SUB_DHCP6 = 456,
        TOKEN_SUB_INTERFACES6 = 457,
        TOKEN_SUB_SUBNET6 = 458,
        TOKEN_SUB_POOL6 = 459,
        TOKEN_SUB_PD_POOL = 460,
        TOKEN_SUB_RESERVATION = 461,
        TOKEN_SUB_OPTION_DEFS = 462,
        TOKEN_SUB_OPTION_DEF = 463,
        TOKEN_SUB_OPTION_DATA = 464,
        TOKEN_SUB_HOOKS_LIBRARY = 465,
        TOKEN_SUB_DHCP_DDNS = 466,
        TOKEN_SUB_CONFIG_CONTROL = 467,
        TOKEN_STRING = 468,
        TOKEN_INTEGER = 469,
        TOKEN_FLOAT = 470,
        TOKEN_BOOLEAN = 471
...
switch (yytype)
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_LIBRARY_PATH (location_type l)
      {
        return symbol_type (token::TOKEN_LIBRARY_PATH, std::move (l));
      }
#else
      static
      symbol_type
      make_LIBRARY_PATH (const location_type& l)
      {
        return symbol_type (token::TOKEN_LIBRARY_PATH, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_ALLOCATION_TYPE (location_type l)
      {
        return symbol_type (token::TOKEN_ALLOCATION_TYPE, std::move (l));
      }
#else
      static
      symbol_type
      make_ALLOCATION_TYPE (const location_type& l)
      {
        return symbol_type (token::TOKEN_ALLOCATION_TYPE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CONFIG_DATABASE (location_type l)
      {
        return symbol_type (token::TOKEN_CONFIG_DATABASE, std::move (l));
      }
#else
      static
      symbol_type
      make_CONFIG_DATABASE (const location_type& l)
      {
        return symbol_type (token::TOKEN_CONFIG_DATABASE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CONFIGURATION_TYPE (location_type l)
      {
        return symbol_type (token::TOKEN_CONFIGURATION_TYPE, std::move (l));
      }
#else
      static
      symbol_type
      make_CONFIGURATION_TYPE (const location_type& l)
      {
        return symbol_type (token::TOKEN_CONFIGURATION_TYPE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_INSTANCE_ID (location_type l)
      {
        return symbol_type (token::TOKEN_INSTANCE_ID, std::move (l));
      }
#else
      static
      symbol_type
      make_INSTANCE_ID (const location_type& l)
      {
        return symbol_type (token::TOKEN_INSTANCE_ID, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_LAWFUL_INTERCEPTION_PARAMETERS (location_type l)
      {
        return symbol_type (token::TOKEN_LAWFUL_INTERCEPTION_PARAMETERS, std::move (l));
      }
#else
      static
      symbol_type
      make_LAWFUL_INTERCEPTION_PARAMETERS (const location_type& l)
      {
        return symbol_type (token::TOKEN_LAWFUL_INTERCEPTION_PARAMETERS, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_MASTER_DATABASE (location_type l)
      {
        return symbol_type (token::TOKEN_MASTER_DATABASE, std::move (l));
      }
#else
      static
      symbol_type
      make_MASTER_DATABASE (const location_type& l)
      {
        return symbol_type (token::TOKEN_MASTER_DATABASE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_MAX_ADDRESS_UTILIZATION (location_type l)
      {
        return symbol_type (token::TOKEN_MAX_ADDRESS_UTILIZATION, std::move (l));
      }
#else
      static
      symbol_type
      make_MAX_ADDRESS_UTILIZATION (const location_type& l)
      {
        return symbol_type (token::TOKEN_MAX_ADDRESS_UTILIZATION, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_MAX_PD_SPACE_UTILIZATION (location_type l)
      {
        return symbol_type (token::TOKEN_MAX_PD_SPACE_UTILIZATION, std::move (l));
      }
#else
      static
      symbol_type
      make_MAX_PD_SPACE_UTILIZATION (const location_type& l)
      {
        return symbol_type (token::TOKEN_MAX_PD_SPACE_UTILIZATION, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_MAX_STATEMENT_TRIES (location_type l)
      {
        return symbol_type (token::TOKEN_MAX_STATEMENT_TRIES, std::move (l));
      }
#else
      static
      symbol_type
      make_MAX_STATEMENT_TRIES (const location_type& l)
      {
        return symbol_type (token::TOKEN_MAX_STATEMENT_TRIES, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_NOTIFICATIONS (location_type l)
      {
        return symbol_type (token::TOKEN_NOTIFICATIONS, std::move (l));
      }
#else
      static
      symbol_type
      make_NOTIFICATIONS (const location_type& l)
      {
        return symbol_type (token::TOKEN_NOTIFICATIONS, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_ON_BOOT_REQUEST_CONFIGURATION_FROM_KEA_NETCONF (location_type l)
      {
        return symbol_type (token::TOKEN_ON_BOOT_REQUEST_CONFIGURATION_FROM_KEA_NETCONF, std::move (l));
      }
#else
      static
      symbol_type
      make_ON_BOOT_REQUEST_CONFIGURATION_FROM_KEA_NETCONF (const location_type& l)
      {
        return symbol_type (token::TOKEN_ON_BOOT_REQUEST_CONFIGURATION_FROM_KEA_NETCONF, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_OPTION_SET_DESCRIPTION (location_type l)
      {
        return symbol_type (token::TOKEN_OPTION_SET_DESCRIPTION, std::move (l));
      }
#else
      static
      symbol_type
      make_OPTION_SET_DESCRIPTION (const location_type& l)
      {
        return symbol_type (token::TOKEN_OPTION_SET_DESCRIPTION, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_OPTION_SET_ID (location_type l)
      {
        return symbol_type (token::TOKEN_OPTION_SET_ID, std::move (l));
      }
#else
      static
      symbol_type
      make_OPTION_SET_ID (const location_type& l)
      {
        return symbol_type (token::TOKEN_OPTION_SET_ID, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_POLICY_ENGINE_PARAMETERS (location_type l)
      {
        return symbol_type (token::TOKEN_POLICY_ENGINE_PARAMETERS, std::move (l));
      }
#else
      static
      symbol_type
      make_POLICY_ENGINE_PARAMETERS (const location_type& l)
      {
        return symbol_type (token::TOKEN_POLICY_ENGINE_PARAMETERS, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_PRIVACY_HISTORY_SIZE (location_type l)
      {
        return symbol_type (token::TOKEN_PRIVACY_HISTORY_SIZE, std::move (l));
      }
#else
      static
      symbol_type
      make_PRIVACY_HISTORY_SIZE (const location_type& l)
      {
        return symbol_type (token::TOKEN_PRIVACY_HISTORY_SIZE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_PRIVACY_VALID_LIFETIME (location_type l)
      {
        return symbol_type (token::TOKEN_PRIVACY_VALID_LIFETIME, std::move (l));
      }
#else
      static
      symbol_type
      make_PRIVACY_VALID_LIFETIME (const location_type& l)
      {
        return symbol_type (token::TOKEN_PRIVACY_VALID_LIFETIME, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOKEN_PROTOCOL, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOKEN_PROTOCOL, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
  ...
  private:
    ...
    {
      yyeof_ = 0,
      yylast_ = 1325,     ///< Last index in yytable_.
      yynnts_ = 456,  ///< Number of nonterminal symbols.
      yyfinal_ = 30, ///< Termination state number.
      yyntokens_ = 217  ///< Number of tokens.
    };
  ...
  Dhcp6Parser::yytranslate_ (int t)
  {
    ...
    const int user_token_number_max_ = 471;

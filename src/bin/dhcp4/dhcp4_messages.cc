// File created from ../../../src/bin/dhcp4/dhcp4_messages.mes on Mon Aug 17 2020 17:11
...
extern const isc::log::MessageID DHCP4_DHCP4O6_NO_SADDR_OPTION = "DHCP4_DHCP4O6_NO_SADDR_OPTION";
...
extern const isc::log::MessageID DHCP4_ERROR = "DHCP4_ERROR";
extern const isc::log::MessageID DHCP4_FLEX_ID = "DHCP4_FLEX_ID";
extern const isc::log::MessageID DHCP4_FORCE_RELOAD_CONFIGURATION = "DHCP4_FORCE_RELOAD_CONFIGURATION";
...
extern const isc::log::MessageID DHCP4_INFO = "DHCP4_INFO";
...
extern const isc::log::MessageID DHCP4_MASTER_CONFIGURATION_CHANGED = "DHCP4_MASTER_CONFIGURATION_CHANGED";
...
extern const isc::log::MessageID DHCP4_PACKET_PROCESS_FAIL = "DHCP4_PACKET_PROCESS_FAIL";
...
extern const isc::log::MessageID DHCP4_SHARD_CONFIGURATION_CHANGED = "DHCP4_SHARD_CONFIGURATION_CHANGED";
...
extern const isc::log::MessageID DHCP4_TRANSACTION_FAILED = "DHCP4_TRANSACTION_FAILED";
extern const isc::log::MessageID DHCP4_WARNING = "DHCP4_WARNING";
...
const char* values[] = {
    ...
    "DHCP4_BUFFER_UNPACK", "parsing buffer received from %1 to %2 over interface %3, localAddr=[%2], remoteAddr=[%1]",
    ...
    "DHCP4_DHCP4O6_NO_SADDR_OPTION", "DHCPv4o6 packet contains no OPTION_DHCP4O6_S46_SADDR",
    "DHCP4_DHCP4O6_PACKET_RECEIVED", "received DHCPv4o6 packet from DHCPv4 server (type %1), msgtype=%1, for %2 on interface %3",
    "DHCP4_DHCP4O6_PACKET_SEND", "%1: trying to send packet %2 (type %3), msgtype=%3, to %4 port %5 on interface %6 encapsulating %7: %8 (type %9), msgtype=%9",
    ...
    "DHCP4_DHCP4O6_RESPONSE_DATA", "%1: responding with packet %2 (type %3), msgtype=%3, packet details: %4",
    ...
    "DHCP4_PACKET_PROCESS_FAIL", "processing of %1 message, msgtype=%1, received from %2 failed: %3, remoteAddr=[%2]",
    ...
    "DHCP4_PACKET_RECEIVED", "%1: %2 (type %3), msgtype=%3, received from %4 to %5 on interface %6, localAddr=[%5], remoteAddr=[%4]",
    "DHCP4_PACKET_SEND", "%1: trying to send packet %2 (type %3), msgtype=%3, from %4:%5 to %6:%7 on interface %8, localAddr=[%4:%5], remoteAddr=[%6:%7]",
    ...
    "DHCP4_RESPONSE_DATA", "%1: responding with packet %2 (type %3), msgtype=%3, packet details: %4",

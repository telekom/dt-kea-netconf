...
public:
    ...
    Dhcp4Client(std::shared_ptr<NakedDhcpv4Srv> srv,
    ...
    /// included.
    void doDiscover(const std::shared_ptr<asiolink::IOAddress>&
                    requested_addr = std::shared_ptr<asiolink::IOAddress>());
    ...
    void doDORA(const std::shared_ptr<asiolink::IOAddress>&
                requested_addr = std::shared_ptr<asiolink::IOAddress>());
    ...
    std::shared_ptr<NakedDhcpv4Srv> getServer() const {
        return (srv_);
    }
...
private:
    ...
    std::shared_ptr<NakedDhcpv4Srv> srv_;

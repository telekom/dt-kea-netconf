...
public:
    ...
    std::shared_ptr<NakedDhcpv4Srv> server_;
...
TEST_F(HooksDhcpv4SrvTest, leases4CommittedRequest) {
    ...
    client.setIfaceName("eth1");
    client.setIfaceIndex(ETH1_INDEX);
    ASSERT_NO_THROW(client.doDORA(std::shared_ptr<IOAddress>(new IOAddress("192.0.2.100"))));
...
TEST_F(HooksDhcpv4SrvTest, leases4CommittedParkRequests) {
    ...
    ASSERT_NO_THROW(client1.doDORA(std::shared_ptr<IOAddress>(new IOAddress("192.0.2.100"))));
    ...
    ASSERT_NO_THROW(client2.doDORA(std::shared_ptr<IOAddress>(new IOAddress("192.0.2.101"))));
...
TEST_F(HooksDhcpv4SrvTest, HooksDecline) {
    ...
    OptionCustomPtr opt_declined_addr = std::dynamic_pointer_cast<
...
TEST_F(LoadUnloadDhcpv4SrvTest, Dhcpv4SrvConfigured) {
    std::shared_ptr<ControlledDhcpv4Srv> srv(new ControlledDhcpv4Srv(0));

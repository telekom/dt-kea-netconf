...
typedef std::shared_ptr<TestCBControlDHCPv4> TestCBControlDHCPv4Ptr;
...
public:
    ...
    void testConfigBackendTimer(const int config_wait_fetch_time,
        ...
        std::unique_ptr<NakedControlledDhcpv4Srv> srv;
        ...
        auto cb_control = std::dynamic_pointer_cast<TestCBControlDHCPv4>(srv->getCBControl());

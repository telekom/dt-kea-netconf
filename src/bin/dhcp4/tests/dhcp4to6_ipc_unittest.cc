...
public:
    ...
    static int buffer4_receive_callout(CalloutHandle& callout_handle) {
        ...
        Pkt4o6Ptr pkt4 = std::dynamic_pointer_cast<Pkt4o6>(callback_recv_pkt_);
        if (pkt4) {
    ...
    static int buffer4_send_callout(CalloutHandle& callout_handle) {
        ...
        Pkt4o6Ptr pkt4 = std::dynamic_pointer_cast<Pkt4o6>(callback_sent_pkt_);
        if (pkt4) {
...
TEST_F(Dhcp4to6IpcTest, receive) {
    ...
    Pkt4o6Ptr pkt_received =
        std::dynamic_pointer_cast<Pkt4o6>(pkt4_received);
...
TEST_F(Dhcp4to6IpcTest, process) {
    ...
    Pkt4o6Ptr pkt_sent = std::dynamic_pointer_cast<Pkt4o6>(pkt4_sent);

...
public:
    /// @brief Constructor.
    NetconfControllerTest() : DControllerTest(NetconfController::instance) {
    }

    /// @brief Returns pointer to NetconfProcess instance.
    NetconfProcessPtr getNetconfProcess() {
        return std::dynamic_pointer_cast<NetconfProcess>(getProcess());
    }
...
TEST_F(NetconfControllerTest, basicInstanceTesting) {
    ...
    ASSERT_NO_THROW(std::dynamic_pointer_cast<NetconfController>(controller));
...
TEST_F(NetconfControllerTest, commandLineArgs) {
    char* argv[] = {const_cast<char*>("progName"), const_cast<char*>("-c"),
                    const_cast<char*>(DControllerTest::CFG_TEST_FILE), const_cast<char*>("-d")};
    int argc = 4;
    ...
    char* argv2[] = {const_cast<char*>("progName"), const_cast<char*>("-x")};
    argc = 2;

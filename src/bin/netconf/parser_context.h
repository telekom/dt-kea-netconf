...
struct ParserContext {
    ...
    ParserContext() : sfile_(0), ctx_(NO_KEYWORDS), trace_scanning_(false), trace_parsing_(false) {
    }
    ...
    enum LexerContext {
        ...
        /// Used while parsing /Netconf/models
        MODELS,

        ///< Used while parsing /Netconf/models[]
        MODEL,

        ///< Used while parsing /Netconf/models[]/configuration
        CONFIGURATION,

        ///< Used while parsing /Netconf/models[]/notifications
        NOTIFICATIONS,

        ///< Used while parsing /Netconf/models[]/operational
        OPERATIONAL,

        ///< Used while parsing /Netconf/models[]/rpc
        RPC,

        ///< Used while parsing /Netconf/models[]/*/control-socket
        CONTROL_SOCKET,

        ///< Used while parsing /Netconf/models[]/*/control-socket/socket-type.
        SOCKET_TYPE,

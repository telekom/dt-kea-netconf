...
public:
    ...
    ///
    /// @throw DProcessBaseError if an operational error is encountered.
    virtual isc::data::ElementPtr shutdown(isc::data::ElementPtr args);
    ...
    virtual isc::data::ElementPtr configure(isc::data::ElementPtr config_set,
...
using NetconfProcessPtr = std::shared_ptr<NetconfProcess>;

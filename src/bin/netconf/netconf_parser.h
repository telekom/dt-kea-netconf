  ...
  private:
    ...
    struct token
    {
      enum yytokentype
      {
        ...
        TOKEN_COMMENT = 267,
        TOKEN_CONFIGURATION = 268,
        TOKEN_CONTROL_SOCKET = 269,
        TOKEN_HTTP = 270,
        TOKEN_KEA_CONFIG_TOOL = 271,
        TOKEN_MODEL = 272,
        TOKEN_MODELS = 273,
        TOKEN_NOTIFICATIONS = 274,
        TOKEN_ON_BOOT_UPDATE_SOCKET = 275,
        TOKEN_ON_BOOT_UPDATE_SYSREPO = 276,
        TOKEN_OPERATIONAL = 277,
        TOKEN_RPC = 278,
        TOKEN_SOCKET_NAME = 279,
        TOKEN_SOCKET_TYPE = 280,
        TOKEN_SOCKET_URL = 281,
        TOKEN_STDOUT = 282,
        TOKEN_SUBSCRIBE = 283,
        TOKEN_UNIX = 284,
        TOKEN_VALIDATE = 285,
        TOKEN_HOOKS_LIBRARIES = 286,
        TOKEN_LIBRARY = 287,
        TOKEN_PARAMETERS = 288,
        TOKEN_LOGGERS = 289,
        TOKEN_NAME = 290,
        TOKEN_OUTPUT_OPTIONS = 291,
        TOKEN_OUTPUT = 292,
        TOKEN_DEBUGLEVEL = 293,
        TOKEN_SEVERITY = 294,
        TOKEN_FLUSH = 295,
        TOKEN_MAXSIZE = 296,
        TOKEN_MAXVER = 297,
        TOKEN_PATTERN = 298,
        TOKEN_START_JSON = 299,
        TOKEN_START_NETCONF = 300,
        TOKEN_START_SUB_NETCONF = 301,
        TOKEN_STRING = 302,
        TOKEN_INTEGER = 303,
        TOKEN_FLOAT = 304,
        TOKEN_BOOLEAN = 305
...
switch (yytype)
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == token::TOKEN_END || tok == token::TOKEN_COMMA || tok == token::TOKEN_COLON || tok == token::TOKEN_LSQUARE_BRACKET || tok == token::TOKEN_RSQUARE_BRACKET || tok == token::TOKEN_LCURLY_BRACKET || tok == token::TOKEN_RCURLY_BRACKET || tok == token::TOKEN_NULL_TYPE || tok == token::TOKEN_NETCONF || tok == token::TOKEN_USER_CONTEXT || tok == token::TOKEN_COMMENT || tok == token::TOKEN_CONFIGURATION || tok == token::TOKEN_CONTROL_SOCKET || tok == token::TOKEN_HTTP || tok == token::TOKEN_KEA_CONFIG_TOOL || tok == token::TOKEN_MODEL || tok == token::TOKEN_MODELS || tok == token::TOKEN_NOTIFICATIONS || tok == token::TOKEN_ON_BOOT_UPDATE_SOCKET || tok == token::TOKEN_ON_BOOT_UPDATE_SYSREPO || tok == token::TOKEN_OPERATIONAL || tok == token::TOKEN_RPC || tok == token::TOKEN_SOCKET_NAME || tok == token::TOKEN_SOCKET_TYPE || tok == token::TOKEN_SOCKET_URL || tok == token::TOKEN_STDOUT || tok == token::TOKEN_SUBSCRIBE || tok == token::TOKEN_UNIX || tok == token::TOKEN_VALIDATE || tok == token::TOKEN_HOOKS_LIBRARIES || tok == token::TOKEN_LIBRARY || tok == token::TOKEN_PARAMETERS || tok == token::TOKEN_LOGGERS || tok == token::TOKEN_NAME || tok == token::TOKEN_OUTPUT_OPTIONS || tok == token::TOKEN_OUTPUT || tok == token::TOKEN_DEBUGLEVEL || tok == token::TOKEN_SEVERITY || tok == token::TOKEN_FLUSH || tok == token::TOKEN_MAXSIZE || tok == token::TOKEN_MAXVER || tok == token::TOKEN_PATTERN || tok == token::TOKEN_START_JSON || tok == token::TOKEN_START_NETCONF || tok == token::TOKEN_START_SUB_NETCONF);
      }
#else
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_CONFIGURATION (location_type l)
      {
        return symbol_type (token::TOKEN_CONFIGURATION, std::move (l));
      }
#else
      static
      symbol_type
      make_CONFIGURATION (const location_type& l)
      {
        return symbol_type (token::TOKEN_CONFIGURATION, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_KEA_CONFIG_TOOL (location_type l)
      {
        return symbol_type (token::TOKEN_KEA_CONFIG_TOOL, std::move (l));
      }
#else
      static
      symbol_type
      make_KEA_CONFIG_TOOL (const location_type& l)
      {
        return symbol_type (token::TOKEN_KEA_CONFIG_TOOL, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_MODELS (location_type l)
      {
        return symbol_type (token::TOKEN_MODELS, std::move (l));
      }
#else
      static
      symbol_type
      make_MODELS (const location_type& l)
      {
        return symbol_type (token::TOKEN_MODELS, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_ON_BOOT_UPDATE_SOCKET (location_type l)
      {
        return symbol_type (token::TOKEN_ON_BOOT_UPDATE_SOCKET, std::move (l));
      }
#else
      static
      symbol_type
      make_ON_BOOT_UPDATE_SOCKET (const location_type& l)
      {
        return symbol_type (token::TOKEN_ON_BOOT_UPDATE_SOCKET, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_ON_BOOT_UPDATE_SYSREPO (location_type l)
      {
        return symbol_type (token::TOKEN_ON_BOOT_UPDATE_SYSREPO, std::move (l));
      }
#else
      static
      symbol_type
      make_ON_BOOT_UPDATE_SYSREPO (const location_type& l)
      {
        return symbol_type (token::TOKEN_ON_BOOT_UPDATE_SYSREPO, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_OPERATIONAL (location_type l)
      {
        return symbol_type (token::TOKEN_OPERATIONAL, std::move (l));
      }
#else
      static
      symbol_type
      make_OPERATIONAL (const location_type& l)
      {
        return symbol_type (token::TOKEN_OPERATIONAL, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RPC (location_type l)
      {
        return symbol_type (token::TOKEN_RPC, std::move (l));
      }
#else
      static
      symbol_type
      make_RPC (const location_type& l)
      {
        return symbol_type (token::TOKEN_RPC, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_SUBSCRIBE (location_type l)
      {
        return symbol_type (token::TOKEN_SUBSCRIBE, std::move (l));
      }
#else
      static
      symbol_type
      make_SUBSCRIBE (const location_type& l)
      {
        return symbol_type (token::TOKEN_SUBSCRIBE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_VALIDATE (location_type l)
      {
        return symbol_type (token::TOKEN_VALIDATE, std::move (l));
      }
#else
      static
      symbol_type
      make_VALIDATE (const location_type& l)
      {
        return symbol_type (token::TOKEN_VALIDATE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static

...
public:
    ...
    void testStockResponse(const HttpStatusCode& status_code,
        ...
        HttpResponseJsonPtr response_json = std::dynamic_pointer_cast<
    ...
    ElementPtr fooCommandHandler(const std::string& /*command_name*/,
                                      const ElementPtr& /*command_arguments*/) {
...
TEST_F(CtrlAgentResponseCreatorTest, createNewHttpRequest) {
    ...
    PostHttpRequestJsonPtr request_json = std::dynamic_pointer_cast<

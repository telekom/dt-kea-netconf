...
public:
    ...
    virtual isc::data::ElementPtr
        shutdown(isc::data::ElementPtr args);
    ...
    virtual isc::data::ElementPtr
    configure(isc::data::ElementPtr config_set,
...
private:
    ...
    isc::data::ElementPtr current_control_socket_;

};

/// @brief Defines a shared pointer to D2Process.
typedef std::shared_ptr<D2Process> D2ProcessPtr;

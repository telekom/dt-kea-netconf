...
TSIGKeyInfoPtr
TSIGKeyInfoParser::parse(ElementPtr key_config) {
    ...
    ElementPtr user_context = key_config->get("user-context");
...
TSIGKeyInfoMapPtr
TSIGKeyInfoListParser::parse(ElementPtr key_list) {
    TSIGKeyInfoMapPtr keys(new TSIGKeyInfoMap());
    ElementPtr key_config;
...
DnsServerInfoPtr
DnsServerInfoParser::parse(ElementPtr server_config) {
    ...
    ElementPtr user_context = server_config->get("user-context");
...
DnsServerInfoListParser::parse(ElementPtr server_list) {
...
DdnsDomainPtr DdnsDomainParser::parse(ElementPtr domain_config,
    ...
    ElementPtr user_context = domain_config->get("user-context");
...
DdnsDomainMapPtr DdnsDomainListParser::parse(ElementPtr domain_list,
                                             const TSIGKeyInfoMapPtr keys) {
    DdnsDomainMapPtr domains(new DdnsDomainMap());
    DdnsDomainParser parser;
    ElementPtr domain_config;

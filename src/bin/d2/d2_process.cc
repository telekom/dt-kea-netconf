...
D2Process::run() {
    ...
    D2ControllerPtr controller =
        std::dynamic_pointer_cast<D2Controller>(D2Controller::instance());
    try {
...
isc::data::ElementPtr
D2Process::shutdown(isc::data::ElementPtr args) {
    LOG_DEBUG(d2_logger, isc::log::DBGLVL_START_SHUT,
...
isc::data::ElementPtr
D2Process::configure(isc::data::ElementPtr config_set, bool check_only) {
...
D2Process::getD2CfgMgr() {
    ...
    return (std::dynamic_pointer_cast<D2CfgMgr>(getCfgMgr()));
}
...
D2Process::reconfigureCommandChannel() {
    ...
    isc::data::ElementPtr sock_cfg = getD2CfgMgr()->getControlSocketInfo();

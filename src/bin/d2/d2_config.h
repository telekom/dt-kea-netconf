...
typedef std::shared_ptr<D2Params> D2ParamsPtr;
...
typedef std::shared_ptr<TSIGKeyInfo> TSIGKeyInfoPtr;
...
typedef std::shared_ptr<TSIGKeyInfoMap> TSIGKeyInfoMapPtr;
...
typedef std::shared_ptr<DnsServerInfo> DnsServerInfoPtr;
...
typedef std::shared_ptr<DnsServerInfoStorage> DnsServerInfoStoragePtr;
...
typedef std::shared_ptr<DdnsDomain> DdnsDomainPtr;
...
typedef std::shared_ptr<DdnsDomainMap> DdnsDomainMapPtr;
...
/// @brief Defines a pointer for DdnsDomain instances.
typedef std::shared_ptr<DdnsDomainListMgr> DdnsDomainListMgrPtr;
...
typedef std::shared_ptr<DScalarContext> DScalarContextPtr;
...
public:
    ...
    TSIGKeyInfoPtr parse(data::ElementPtr key_config);
...
public:
    ...
    TSIGKeyInfoMapPtr parse(data::ElementPtr key_list_config);
};
...
public:
    ...
    /// -# port is 0
    DnsServerInfoPtr parse(data::ElementPtr server_config);
};
...
public:
    ...
    DnsServerInfoStoragePtr parse(data::ElementPtr server_list_config);
};
...
public:
    ...
    DdnsDomainPtr parse(data::ElementPtr domain_config,
...
public:
    ...
    DdnsDomainMapPtr parse(data::ElementPtr domain_list_config,
                           const TSIGKeyInfoMapPtr keys);
};
...
public:
    ...
    DdnsDomainListMgrPtr parse(data::ElementPtr mgr_config,

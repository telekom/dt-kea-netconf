...
typedef std::shared_ptr<TestConfigBackend> TestConfigBackendPtr;
...
typedef std::shared_ptr<TestConfigBackendImpl1> TestConfigBackendImpl1Ptr;
...
typedef std::shared_ptr<TestConfigBackendImpl2> TestConfigBackendImpl2Ptr;

...
typedef std::shared_ptr<NameChangeRequest> NameChangeRequestPtr;
...
public:
    ...
    void setChangeType(isc::data::ElementPtr element);
    ...
    /// Element
    void setForwardChange(isc::data::ElementPtr element);
    ...
    /// @throw NcrMessageError if the element is not a boolean
    /// Element
    void setReverseChange(isc::data::ElementPtr element);
    ...
    /// Element
    void setFqdn(isc::data::ElementPtr element);
    ...
    /// @throw NcrMessageError if the element is not a string
    /// Element
    void setIpAddress(isc::data::ElementPtr element);
    ...
    /// @throw NcrMessageError if the input data contains non-digits
    /// or there is an odd number of digits.
    void setDhcid(isc::data::ElementPtr element);
    ...
    void setLeaseExpiresOn(isc::data::ElementPtr element);
    ...
    /// @throw NcrMessageError if the element is not a string
    /// Element
    void setLeaseLength(isc::data::ElementPtr element);
    ...
    /// the map
    isc::data::ElementPtr getElement(const std::string& name,
    ...
    bool operator == (NameChangeRequest& b);
    bool operator != (const NameChangeRequest& b);
    bool operator != (NameChangeRequest& b);

private:
    bool equals(NameChangeRequest const& b);

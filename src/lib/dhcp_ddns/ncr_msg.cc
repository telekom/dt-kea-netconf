...
void
NameChangeRequest::setChangeType(isc::data::ElementPtr element) {
    long raw_value = -1;
    try {
...
void
NameChangeRequest::setForwardChange(isc::data::ElementPtr element) {
    bool value;
    try {
...
void
NameChangeRequest::setReverseChange(isc::data::ElementPtr element) {
    bool value;
    try {
        // Get the element's boolean value.
        value = element->boolValue();
...
void
NameChangeRequest::setFqdn(isc::data::ElementPtr element) {
...
void
NameChangeRequest::setIpAddress(isc::data::ElementPtr element) {
...
void
NameChangeRequest::setDhcid(isc::data::ElementPtr element) {
...
void NameChangeRequest::setLeaseExpiresOn(isc::data::ElementPtr element) {
...
void
NameChangeRequest::setLeaseLength(isc::data::ElementPtr element) {
    long value = -1;
    try {
        // Get the element's integer value.
...
bool
NameChangeRequest::equals(NameChangeRequest const& other) {
...
bool
NameChangeRequest::operator == (NameChangeRequest& other) {
    return equals(other);
}

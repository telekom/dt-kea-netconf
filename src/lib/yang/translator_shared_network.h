...
/// - kea-dhcp4-server
/// - kea-dhcp6-server
struct TranslatorSharedNetwork : virtual public TranslatorSubnets {
    ...
    void setSharedNetwork(const std::string& xpath, isc::data::ElementPtr elem);
...
/// - kea-dhcp4-server
/// - kea-dhcp6-server
struct TranslatorSharedNetworks : virtual public TranslatorSharedNetwork {
    using S_Session = sysrepo::S_Session;
    ...
    /// @param xpath The xpath of the shared network list.
    /// @param elem The JSON element.
    void setSharedNetworks(const std::string& xpath, isc::data::ElementPtr elem);
...
protected:
    ...
    void setSharedNetworksKea(const std::string& xpath, isc::data::ElementPtr elem);
};

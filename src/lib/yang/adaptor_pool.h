...
struct AdaptorPool {
    ...
    static void
    fromSubnet(const std::string& model, isc::data::ElementPtr subnet, isc::data::ElementPtr pools);
    ...
    static void
    toSubnet(const std::string& model, isc::data::ElementPtr subnet, isc::data::ElementPtr pools);
...
protected:
    ...
    /// @param subnet The subnet element.
    /// @param pools The children pools.
    static void fromSubnetIetf6(isc::data::ElementPtr subnet, isc::data::ElementPtr pools);
    ...
    /// @param subnet The subnet element.
    /// @param pools The children pools.
    static void toSubnetIetf6(isc::data::ElementPtr subnet, isc::data::ElementPtr pools);
};

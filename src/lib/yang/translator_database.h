...
/// - kea-dhcp4-server
/// - kea-dhcp6-server
struct TranslatorDatabase : virtual public TranslatorBasic {
    ...
    void setDatabase(const std::string& xpath, isc::data::ElementPtr elem, bool skip = false);
...
protected:
    ...
    void setDatabaseKea(const std::string& xpath, isc::data::ElementPtr elem, bool skip);
};
...
struct TranslatorDatabases : virtual public TranslatorDatabase {
    using S_Session = sysrepo::S_Session;
    ...
    /// @throw SysrepoError when sysrepo raises an error.
    isc::data::ElementPtr getDatabases(const std::string& xpath);
    ...
    /// @param xpath The xpath of databases including the list name.
    /// @param elem The JSON element.
    void setDatabases(const std::string& xpath, isc::data::ElementPtr elem);
...
protected:
    ...
    /// @param elem The JSON element.
    /// @throw BadValue on database without tyoe,
    void setDatabasesKea(const std::string& xpath, isc::data::ElementPtr elem);
};

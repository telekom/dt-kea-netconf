...
struct TranslatorPdPool : virtual public TranslatorOptionDataList {
    ...
    void setPdPool(const std::string& xpath, isc::data::ElementPtr elem);
...
protected:
    ...
    void setPdPoolIetf6(const std::string& xpath, isc::data::ElementPtr elem);
    ...
    /// @param xpath The xpath of the pd-pool.
    /// @param elem The JSON element.
    void setPdPoolKea(const std::string& xpath, isc::data::ElementPtr elem);
};
...
/// - kea-dhcp6-server
/// - ietf-dhcpv6-server (partial support)
struct TranslatorPdPools : virtual public TranslatorPdPool {
    using S_Session = sysrepo::S_Session;
    ...
    /// @param xpath The xpath of the pd-pool list.
    /// @param elem The JSON element.
    void setPdPools(const std::string& xpath, isc::data::ElementPtr elem);
...
protected:
    ...
    /// @param xpath The xpath of the pd-pool list.
    /// @param elem The JSON element.
    void setPdPoolsId(const std::string& xpath, isc::data::ElementPtr elem);
    ...
    /// @param elem The JSON element.
    /// @throw BadValue on pd-pool without prefix or prefix length.
    void setPdPoolsPrefix(const std::string& xpath, isc::data::ElementPtr elem);
};

...
/// - kea-dhcp-ddns
/// - kea-ctrl-agent
struct TranslatorLogger : virtual public TranslatorBasic {
    ...
    void setLogger(const std::string& xpath, isc::data::ElementPtr elem);
...
protected:
    ...
    /// @param xpath The xpath of the output option.
    /// @param elem The JSON element.
    void setOutputOption(const std::string& xpath, isc::data::ElementPtr elem);
    ...
    void setOutputOptions(const std::string& xpath, isc::data::ElementPtr elem);
    ...
    /// @param xpath The xpath of the logger.
    /// @param elem The JSON element.
    void setLoggerKea(const std::string& xpath, isc::data::ElementPtr elem);
};
...
struct TranslatorLoggers : virtual public TranslatorLogger {
    using S_Session = sysrepo::S_Session;
    ...
    /// @throw SysrepoError when sysrepo raises an error.
    isc::data::ElementPtr getLoggers(const std::string& xpath);

    /// @brief Translate and set loggeres from JSON to YANG.
    ///
    /// @param xpath The xpath of loggers.
    /// @param elem The JSON element.
    void setLoggers(const std::string& xpath, isc::data::ElementPtr elem);
...
protected:
    ...
    void setLoggersKea(const std::string& xpath, isc::data::ElementPtr elem);
};

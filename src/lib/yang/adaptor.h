...
struct MissingKey : public isc::Exception {
    MissingKey(const char* file, size_t line, const char* what) : isc::Exception(file, line, what) {
    }
};
...
struct Adaptor {
    ...
    static isc::data::ElementPtr getContext(isc::data::ElementPtr parent);
    ...
    static void
    fromParent(const std::string& name, isc::data::ElementPtr parent, isc::data::ElementPtr list);
    ...
    /// @param list The children list.
    static void
    toParent(const std::string& name, isc::data::ElementPtr parent, isc::data::ElementPtr list);
    ...
    static void
    modify(isc::data::ElementPtr path, isc::data::ElementPtr actions, isc::data::ElementPtr config);
};

...
const YRTree subnetTwoPoolsTreeIetf6 = {
    ...
    { "/ietf-dhcpv6-server:server/server-config/network-ranges/"
      "network-range[id='111']", "", SR_LIST_T, true },
    { "/ietf-dhcpv6-server:server/server-config/network-ranges/"
      "network-range[id='111']/id",
      "111", SR_UINT32_T, false },
    { "/ietf-dhcpv6-server:server/server-config/network-ranges/"
      "network-range[id='111']/network-prefix",
      "2001:db8::/48", SR_STRING_T, true },
    { "/ietf-dhcpv6-server:server/server-config/network-ranges/"
      "network-range[id='111']/address-pools",
      "", SR_CONTAINER_T, false },
    { "/ietf-dhcpv6-server:server/server-config/network-ranges/"
      "network-range[id='111']/address-pools/"
...
const YRTree validTreeIetf6 = {
    ...
    { "/ietf-dhcpv6-server:server/server-config/network-ranges/"
      ...
      "111", SR_UINT32_T, false },
    { "/ietf-dhcpv6-server:server/server-config/network-ranges/"
      "network-range[id='111']/description",
...
const YRTree designExampleTree = {
    ...
    { "/ietf-dhcpv6-server:server/server-config/network-ranges",
      "", SR_CONTAINER_T, false },
    { "/ietf-dhcpv6-server:server/server-config/network-ranges/"
      "network-range[id='1']", "", SR_LIST_T, true },
    { "/ietf-dhcpv6-server:server/server-config/network-ranges/"
      "network-range[id='1']/id",
      "1", SR_UINT32_T, false },
    { "/ietf-dhcpv6-server:server/server-config/network-ranges/"
      "network-range[id='1']/description",
      "example", SR_STRING_T, true },
    { "/ietf-dhcpv6-server:server/server-config/network-ranges/"
      "network-range[id='1']/network-prefix",
      "2001:db8:20:b00::/56", SR_STRING_T, true },
    { "/ietf-dhcpv6-server:server/server-config/network-ranges/"
      "network-range[id='1']/pd-pools",
      "", SR_CONTAINER_T, false },
    { "/ietf-dhcpv6-server:server/server-config/network-ranges/"
      "network-range[id='1']/pd-pools/"
      "pd-pool[pool-id='0']", "", SR_LIST_T, true },

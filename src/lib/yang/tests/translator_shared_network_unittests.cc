...
struct TranslatorSharedNetworksTest : GenericTranslatorTest<shared_networks, TranslatorSharedNetworks> {
...
TEST_F(TranslatorSharedNetworksTest, getList) {
    ...
    const string& exp_net1 = "{ \"name\": \"foo\", \"subnet6\": [ { \"id\": 1, "
                             "\"subnet\": \"2001:db8:1::/48\" }, "
                             "{ \"id\": 2, \"subnet\": \"2001:db8:2::/48\" } ] }";

    const string& exp_net2 = "{ \"name\": \"bar\", \"subnet6\": [ { \"id\": 101, "
                             "\"subnet\": \"2001:db8:101::/48\" }, "
                             "{ \"id\": 102, \"subnet\": \"2001:db8:102::/48\" } ] }";

    const string exp_both = "[ " + exp_net1 + ", " + exp_net2 + " ]";

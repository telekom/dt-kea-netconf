...
struct TranslatorHostsTest : GenericTranslatorTest<host_reservations, TranslatorHosts> {
...
TEST_F(TranslatorHostsTest, set) {
    ...
    const string& xpath = "/kea-dhcp4-server:config/subnet4[id='111']";
...
TEST_F(TranslatorHostsTest, getMany) {
    ...
    EXPECT_EQ(hosts->str(), "[ { \"hw-address\": \"00:01:02:03:04:05\", "

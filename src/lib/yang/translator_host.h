...
struct TranslatorHost : virtual public TranslatorOptionDataList {
    ...
    void setHost(const std::string& xpath, isc::data::ElementPtr elem);
...
protected:
    ...
    /// @param xpath The xpath of the host reservation.
    /// @param elem The JSON element.
    void setHostKea(const std::string& xpath, isc::data::ElementPtr elem);
};
...
struct TranslatorHosts : virtual public TranslatorHost {
    using S_Session = sysrepo::S_Session;
    ...
    /// @param xpath The xpath of the host reservation list.
    /// @param elem The JSON element.
    void setHosts(const std::string& xpath, isc::data::ElementPtr elem);
...
protected:
    ...
    void setHostsKea(const std::string& xpath, isc::data::ElementPtr elem);
};

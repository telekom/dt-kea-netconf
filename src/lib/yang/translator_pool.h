...
/// @endcode
struct TranslatorPool : virtual public TranslatorOptionDataList {
    ...
    void setPool(const std::string& xpath, isc::data::ElementPtr elem);
    ...
    static void
    getAddresses(const std::string& prefix, std::string& start_address, std::string& end_address);
...
protected:
    ...
    /// not a prefix.
    void setPoolIetf6(const std::string& xpath, isc::data::ElementPtr elem);
    ...
    void setPoolKea(const std::string& xpath, isc::data::ElementPtr elem);
};

/// @brief A translator class for converting pools between YANG and JSON.
///
/// Currently supports on kea-dhcp[46]-server and partially ietf-dhcpv6-server.
struct TranslatorPools : virtual public TranslatorPool {
    using S_Session = sysrepo::S_Session;
    ...
    /// @param xpath The xpath of the pool list.
    /// @param elem The JSON element.
    void setPools(const std::string& xpath, isc::data::ElementPtr elem);
...
protected:
    ...
    /// @param xpath The xpath of the pool list.
    /// @param elem The JSON element.
    void setPoolsById(const std::string& xpath, isc::data::ElementPtr elem);
    ...
    void setPoolsByAddresses(const std::string& xpath, isc::data::ElementPtr elem);
};

...
struct TranslatorSubnet : virtual public TranslatorPools,
                          virtual public TranslatorPdPools,
                          virtual public TranslatorHosts {
    ...
    void setSubnet(const std::string& xpath, isc::data::ElementPtr elem);
...
protected:
    ...
    /// @param xpath The xpath of the subnet.
    /// @param elem The JSON element.
    void setSubnetIetf6(const std::string& xpath, isc::data::ElementPtr elem);
    ...
    /// @param xpath The xpath of the subnet.
    /// @param elem The JSON element.
    void setSubnetKea(const std::string& xpath, isc::data::ElementPtr elem);
};
...
///
/// Currently supports on kea-dhcp[46]-server and partially ietf-dhcpv6-server.
struct TranslatorSubnets : virtual public TranslatorSubnet {
    using S_Session = sysrepo::S_Session;
    ...
    void setSubnets(const std::string& xpath, isc::data::ElementPtr elem);
...
protected:
    ...
    /// @param xpath The xpath of the subnet list.
    /// @param elem The JSON element.
    void setSubnetsIetf6(const std::string& xpath, isc::data::ElementPtr elem);
    ...
    /// @param subsel The subnet list name.
    void
    setSubnetsKea(const std::string& xpath, isc::data::ElementPtr elem, const std::string& subsel);
};

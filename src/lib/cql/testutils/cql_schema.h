...
extern char const* CQL_VALID_TYPE;
...
/// version is incorrect (i.e. does not match CQL_SCHEMA_VERSION),
/// or a SQL error occurs.  Otherwise, the script is should delete
/// all transient data, leaving reference tables intact.
///
/// @param show_err flag which governs whether or not stderr is suppressed.

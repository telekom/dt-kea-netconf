...
struct IOFetchData {
    ...
    std::unique_ptr<IOAsioSocket<IOFetch> > socket;
                                             ///< Socket to use for I/O
    std::unique_ptr<IOEndpoint> remote_snd;///< Where the fetch is sent
    std::unique_ptr<IOEndpoint> remote_rcv;///< Where the response came from
...
{
    data_ = std::shared_ptr<IOFetchData>(new IOFetchData(

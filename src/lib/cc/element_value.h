...
public:
    ...
    T operator()(ElementPtr el) const {
...
public:
    ...
    ///
    /// @param el Element holding a value to be extracted.
    double operator()(ElementPtr el) const {
...
public:
    ...
    ///
    /// @param el Element holding a value to be extracted.
    bool operator()(ElementPtr el) const {
        return (el->boolValue());
    }
...
public:
    ...
    ///
    /// @param el Element holding a value to be extracted.
    std::string operator()(ElementPtr el) const {
...
public:
    ...
    ///
    /// @param el Element holding a value to be extracted.
    asiolink::IOAddress operator()(ElementPtr el) const {

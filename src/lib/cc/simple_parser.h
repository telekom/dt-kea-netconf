...
struct SimpleDefault {
    SimpleDefault(const char* name, isc::data::Element::type_t type, const char* value)
        :name_(name), type_(type), value_(value) {}
    std::string name_;
    isc::data::Element::type_t type_;
    const char* value_;
};
...
typedef std::map<std::string, isc::data::Element::type_t> SimpleKeywords;
...
///   CfgStorage parse(ElementPtr json)
...
class SimpleParser {
 public:
    ...
    static size_t deriveParams(isc::data::ElementPtr parent,
    ...
    /// appropriate type
    static std::string getString(isc::data::ElementPtr scope,
    ...
    /// @throw DhcpConfigError if the parameter is not there or is not of
    /// appropriate type
    static int64_t getInteger(isc::data::ElementPtr scope,
                              const std::string& name);
    ...
    /// @throw DhcpConfigError if the parameter is not there or is not of
    /// appropriate type
    static bool getBoolean(isc::data::ElementPtr scope,
                           const std::string& name);
    ...
    getAddress(const ElementPtr& scope, const std::string& name);
    ...
    /// an Element::real
    static double getDouble(const ElementPtr& scope,
                            const std::string& name);
...
protected:
    ...
    getIntType(isc::data::ElementPtr scope,
               const std::string& name) {
    ...
    getAndConvert(isc::data::ElementPtr scope,
                  const std::string& name,
...
public:
    ...
    uint32_t getUint32(isc::data::ElementPtr scope,
                       const std::string& name) {
    ...
    uint16_t getUint16(isc::data::ElementPtr scope,
                       const std::string& name) {
    ...
    uint8_t getUint8(ElementPtr scope, const std::string& name) {

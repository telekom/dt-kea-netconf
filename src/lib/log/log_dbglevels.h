...
static int constexpr DBGLVL_START_SHUT(0);
...
static int constexpr DBGLVL_TRACE_BASIC(40);

/// Trace data associated with the basic operations.
static int constexpr DBGLVL_TRACE_BASIC_DATA(45);

/// Trace detailed operations.
static int constexpr DBGLVL_TRACE_DETAIL(50);

/// Trace data associated with detailed operations.
static int constexpr DBGLVL_TRACE_DETAIL_DATA(55);

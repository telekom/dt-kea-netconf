...
typedef std::shared_ptr<LoggerValuesList> LoggerValuesListPtr;
...
typedef std::shared_ptr<LoggerDuplicatesList> LoggerDuplicatesListPtr;
//\}
...
private:
    ...
    std::shared_ptr<MessageDictionary> global_dictionary_;

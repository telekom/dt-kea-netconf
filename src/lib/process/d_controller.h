...
typedef std::shared_ptr<DControllerBase> DControllerBasePtr;
...
public:
    ...
    virtual isc::data::ElementPtr updateConfig(isc::data::ElementPtr
                                                    new_config);
    ...
    /// update composed of an integer status value (0 means successful,
    /// non-zero means failure), and a string explanation of the outcome.
    virtual isc::data::ElementPtr checkConfig(isc::data::ElementPtr
                                                   new_config);
    ...
    /// update composed of an integer status value (0 means successful,
    /// non-zero means failure), and a string explanation of the outcome.
    virtual isc::data::ElementPtr configFromFile();
...
protected:
    ...
    ///
    virtual isc::data::ElementPtr parseFile(const std::string& file_name);
    ...
    /// @return pointer to the elements created
    ///
    virtual isc::data::ElementPtr parseText(const std::string& input) {
    ...
    isc::data::ElementPtr shutdownProcess(isc::data::ElementPtr args);
    ...
    std::string handleOtherObjects(isc::data::ElementPtr args);

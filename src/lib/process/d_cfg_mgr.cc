...
ElementPtr
DCfgMgrBase::simpleParseConfig(ElementPtr config_set,
                               bool check_only,
    ...
    LOG_DEBUG(dctl_logger, isc::log::DBGLVL_COMMAND,
                DCTL_CONFIG_START).arg(prettyPrint(config_set));
...
void
DCfgMgrBase::setCfgDefaults(ElementPtr) {
}

ElementPtr
DCfgMgrBase::parse(ElementPtr, bool) {

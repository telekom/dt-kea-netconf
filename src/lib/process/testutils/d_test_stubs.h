...
public:
    ...
    /// the IO service.
    virtual isc::data::ElementPtr shutdown(isc::data::ElementPtr);
    ...
    configure(isc::data::ElementPtr config_set, bool check_only);
...
protected:
    ...
    virtual isc::data::ElementPtr parseFile(const std::string&);
...
typedef std::shared_ptr<DStubController> DStubControllerPtr;
...
public:
    ...
    isc::data::ElementPtr updateConfig(isc::data::ElementPtr
                                            new_config) {
    ...
    isc::data::ElementPtr checkConfig(isc::data::ElementPtr
                                           new_config) {
...
typedef std::shared_ptr<DStubContext> DStubContextPtr;
...
public:
    ...
    ///
    isc::data::ElementPtr
    parse(isc::data::ElementPtr config, bool check_only);
...
typedef std::shared_ptr<DStubCfgMgr> DStubCfgMgrPtr;
...
public:
    ...
    /// @return returns AssertionSuccess if there were no parsing errors,
    /// AssertionFailure otherwise.
    ::testing::AssertionResult checkAnswer(isc::data::ElementPtr answer,
                                           int should_be) {
        int rcode = 0;

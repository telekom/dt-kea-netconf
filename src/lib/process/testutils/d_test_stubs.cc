...
isc::data::ElementPtr
DStubProcess::shutdown(isc::data::ElementPtr /* args */) {
...
isc::data::ElementPtr
DStubProcess::configure(isc::data::ElementPtr config_set, bool check_only) {
...
isc::data::ElementPtr
DStubCfgMgr::parse(isc::data::ElementPtr /*config*/, bool /*check_only*/) {

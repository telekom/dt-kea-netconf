...
/// @brief Defines a map of ElementPtrs keyed by name
...
public:
    ...
    isc::data::ElementPtr
    simpleParseConfig(isc::data::ElementPtr config,
...
protected:
    ...
    /// of an integer status value (0 means successful, non-zero means failure),
    /// and a string explanation of the outcome.
    virtual isc::data::ElementPtr parse(isc::data::ElementPtr config,
                                             bool check_only);
...
typedef std::shared_ptr<DCfgMgrBase> DCfgMgrBasePtr;

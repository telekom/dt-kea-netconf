...
typedef std::shared_ptr<PostHttpRequestJson> PostHttpRequestJsonPtr;
/// @brief Pointer to const @ref PostHttpRequestJson.
typedef std::shared_ptr<const PostHttpRequestJson> ConstPostHttpRequestJsonPtr;
...
public:
    ...
    data::ElementPtr getBodyAsJson() const;
    ...
    void setBodyAsJson(const data::ElementPtr& body);
    ...
    /// doesn't exist.
    /// @throw HttpRequestJsonError if an error occurred.
    data::ElementPtr getJsonElement(const std::string& element_name) const;

...
TEST(AddrUtilitiesTest, applyThresholdToRange) {
    EXPECT_EQ(56, applyThresholdToRange(56, 56, 100));
    EXPECT_EQ(56, applyThresholdToRange(56, 56, 80));
    EXPECT_EQ(56, applyThresholdToRange(56, 56, 10));

    EXPECT_EQ(56, applyThresholdToRange(56, 64, 100));
    EXPECT_EQ(56, applyThresholdToRange(56, 64, 80));
    EXPECT_EQ(57, applyThresholdToRange(56, 64, 50));
    EXPECT_EQ(58, applyThresholdToRange(56, 64, 25));
    EXPECT_EQ(59, applyThresholdToRange(56, 64, 12));
    EXPECT_EQ(60, applyThresholdToRange(56, 64, 6));

    EXPECT_EQ(127, applyThresholdToRange(127, 128, 100));
    EXPECT_EQ(128, applyThresholdToRange(127, 128, 50));
    // 1% of 2 addresses should mean deactivated pool
    EXPECT_THROW(applyThresholdToRange(127, 128, 1), isc::OutOfRange);

    // This is a /65 range and a 50% threshold resulting in a /66 range
    auto [min_ipv6, max_ipv6] = applyThresholdToRange(IOAddress("2003:1c09:21:c00::"),
            IOAddress("2003:1c09:21:c00:7fff:ffff:ffff:ffff"), 50);
    EXPECT_STREQ(min_ipv6.toText().c_str(), "2003:1c09:21:c00::");
    EXPECT_STREQ(max_ipv6.toText().c_str(), "2003:1c09:21:c00:3fff:ffff:ffff:ffff");

    // This is a /124 range and a 75% threshold results in having 12 addresses
    std::tie(min_ipv6, max_ipv6) = applyThresholdToRange(IOAddress("2003:1c09:21:c00::"),
            IOAddress("2003:1c09:21:c00::f"), 75);
    EXPECT_STREQ(min_ipv6.toText().c_str(), "2003:1c09:21:c00::");
    EXPECT_STREQ(max_ipv6.toText().c_str(), "2003:1c09:21:c00::b");
}

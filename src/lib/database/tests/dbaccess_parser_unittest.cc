...
public:
    ...
    void parse(ElementPtr database_config) {
...
TEST_F(DbAccessParserTest, validTypeMemfile) {
    ...
    ElementPtr json_elements = Element::fromJSON(json_config);
...
TEST_F(DbAccessParserTest, multipleHost) {
    ...
    ElementPtr json_elements1 = Element::fromJSON(json_config1);
    ElementPtr json_elements2 = Element::fromJSON(json_config2);

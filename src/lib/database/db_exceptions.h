...
/// @brief The timestamp part of a CAS check has changed
struct TimestampHasChanged : public StatementNotApplied {
    TimestampHasChanged(const char* file, size_t line, const char* what)
        : StatementNotApplied(file, line, what) {
    }
};

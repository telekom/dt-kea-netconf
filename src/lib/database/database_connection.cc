...
#ifdef TERASTREAM
bool DatabaseConnection::enable_all_traces_;
#endif  // TERASTREAM
...
std::string
DatabaseConnection::redactedAccessString(ParameterMap const& parameters) {
...
isc::data::ElementPtr
DatabaseConnection::toElement(ParameterMap const& params) {

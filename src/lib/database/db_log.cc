...
const DbLogger::MessageMap db_message_map = {
    ...
    { CQL_TRANSACTION_MGR_COMMIT_TRANSACTION, DATABASE_CQL_TRANSACTION_MGR_COMMIT_TRANSACTION },
    { CQL_TRANSACTION_MGR_REGISTER_TRANSACTION, DATABASE_CQL_TRANSACTION_MGR_REGISTER_TRANSACTION },
    { CQL_TRANSACTION_MGR_REGISTER_TRANSACTION_COMMIT, DATABASE_CQL_TRANSACTION_MGR_REGISTER_TRANSACTION_COMMIT },
    { CQL_TRANSACTION_MGR_REGISTER_TRANSACTION_ROLLBACK, DATABASE_CQL_TRANSACTION_MGR_REGISTER_TRANSACTION_ROLLBACK },
    { CQL_TRANSACTION_MGR_ROLLBACK_TRANSACTION, DATABASE_CQL_TRANSACTION_MGR_ROLLBACK_TRANSACTION },
    { CQL_TRANSACTION_MGR_START_TRANSACTION, DATABASE_CQL_TRANSACTION_MGR_START_TRANSACTION },
    { CQL_TRANSACTION_MGR_TRANSACTION_COMMIT, DATABASE_CQL_TRANSACTION_MGR_TRANSACTION_COMMIT },
    { CQL_TRANSACTION_MGR_TRANSACTION_NOT_FOUND, DATABASE_CQL_TRANSACTION_MGR_TRANSACTION_NOT_FOUND },
    { CQL_TRANSACTION_MGR_TRANSACTION_ROLLBACK, DATABASE_CQL_TRANSACTION_MGR_TRANSACTION_ROLLBACK },
    { CQL_TRANSACTION_MGR_TRANSACTION_START, DATABASE_CQL_TRANSACTION_MGR_TRANSACTION_START },
};

...
enum DbMessageID {
    ...
    CQL_TRANSACTION_MGR_COMMIT_TRANSACTION,
    CQL_TRANSACTION_MGR_REGISTER_START_TRANSACTION,
    CQL_TRANSACTION_MGR_REGISTER_TRANSACTION,
    CQL_TRANSACTION_MGR_REGISTER_TRANSACTION_COMMIT,
    CQL_TRANSACTION_MGR_REGISTER_TRANSACTION_ROLLBACK,
    CQL_TRANSACTION_MGR_ROLLBACK_TRANSACTION,
    CQL_TRANSACTION_MGR_TRANSACTION_COMMIT,
    CQL_TRANSACTION_MGR_START_TRANSACTION,
    CQL_TRANSACTION_MGR_TRANSACTION_ROLLBACK,
    CQL_TRANSACTION_MGR_TRANSACTION_NOT_FOUND,
    CQL_TRANSACTION_MGR_TRANSACTION_START
};
///@}

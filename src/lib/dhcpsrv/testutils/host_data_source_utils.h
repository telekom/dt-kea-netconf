...
public:
    ...
    ///
    /// @return generated Host object
    static HostPtr initializeHost6(std::string const& address,
    ...
    static void
    compareHwaddrs(const ConstHostPtr& host1, const ConstHostPtr& host2, bool expect_match);
    ...
    static void
    compareDuids(const ConstHostPtr& host1, const ConstHostPtr& host2, bool expect_match);
    ...
    static void compareClientClasses(const ClientClasses& classes1, const ClientClasses& classes2);
    ...
    static void compareOptions(const ConstCfgOptionPtr& cfg1, const ConstCfgOptionPtr& cfg2);
};

...
public:
    ...
    OptionDescriptor createOption(const Option::Universe& universe,
        ...
        std::shared_ptr<OptionType> option(new OptionType(universe, option_type,
                                                            value));
        std::ostringstream s;
        if (formatted) {
    ...
    OptionDescriptor createOption(const uint16_t option_type,
                                  ...
                                  const bool formatted,
                                  const DataType& value) const {
        std::shared_ptr<OptionType> option(new OptionType(option_type, value));
    ...
    createAddressOption(const uint16_t option_type,
        ...
        std::shared_ptr<OptionType> option(new OptionType(option_type,
                                                            addresses));
        OptionDescriptor desc(option, persist, s.str());
        return (desc);
    }

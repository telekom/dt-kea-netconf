...
typedef std::shared_ptr<OptionDescriptor> OptionDescriptorPtr;
...
public:
    ...
    OptionDescriptor(const OptionPtr& opt, bool persist,
                     ...
                     data::ElementPtr user_context = data::ElementPtr())
...
typedef std::shared_ptr<OptionContainer> OptionContainerPtr;
...
typedef std::shared_ptr<CfgOption> CfgOptionPtr;

/// @brief Const pointer.
typedef std::shared_ptr<const CfgOption> ConstCfgOptionPtr;

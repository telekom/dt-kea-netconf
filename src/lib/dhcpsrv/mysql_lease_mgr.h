...
public:
    ...
    std::unique_ptr<MySqlLease4Exchange> exchange4_; ///< Exchange object
    std::unique_ptr<MySqlLease6Exchange> exchange6_; ///< Exchange object
...
using MySqlLeaseContextPtr = std::shared_ptr<MySqlLeaseContext>;
...
typedef std::shared_ptr<MySqlLeaseContextPool> MySqlLeaseContextPoolPtr;

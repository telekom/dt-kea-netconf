...
protected:
    ...
    const Triplet<uint32_t> parseLifetime(const data::ElementPtr& scope,
    ...
    /// to be stored.
    void parseCommon(const data::ElementPtr& network_data,
                     NetworkPtr& network);
    ...
    /// invalid.
    void parseTeePercents(const data::ElementPtr& network_data,
                          NetworkPtr& network);
    ...
    /// @param [out] network Pointer to a network in which parsed data is
    /// to be stored.
    void parseHostReservationMode(const data::ElementPtr& network_data,
                                  NetworkPtr& network);
    ...
    /// @param [out] network Pointer to a network in which parsed data is
    /// to be stored.
    void parseDdnsParams(const data::ElementPtr& network_data,
                         NetworkPtr& network);
};

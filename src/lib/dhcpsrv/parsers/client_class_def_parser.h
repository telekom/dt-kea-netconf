...
public:
    ...
    void parse(ExpressionPtr& expression,
               isc::data::ElementPtr expression_cfg,
               uint16_t family,
...
public:
    ...
    void parse(ClientClassDictionaryPtr& class_dictionary,
               isc::data::ElementPtr client_class_def,
               uint16_t family,
    ...
    void checkParametersSupported(const isc::data::ElementPtr& class_def_cfg,
                                  const uint16_t family);
};

/// @brief Defines a pointer to a ClientClassDefParser
typedef std::shared_ptr<ClientClassDefParser> ClientClassDefParserPtr;
...
public:
    ...
    parse(isc::data::ElementPtr class_def_list, uint16_t family);
};

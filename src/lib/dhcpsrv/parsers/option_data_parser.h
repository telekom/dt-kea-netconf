...
public:
    ...
    parse(isc::data::ElementPtr single_option);
...
private:
    ...
    /// are invalid.
    std::pair<OptionDescriptor, std::string>
    createOption(isc::data::ElementPtr option_data);
    ...
    extractCode(data::ElementPtr parent) const;
    ...
    std::string extractData(data::ElementPtr parent) const;
    ...
    std::string extractSpace(data::ElementPtr parent) const;
    ...
    util::Optional<bool> extractPersistent(data::ElementPtr parent) const;

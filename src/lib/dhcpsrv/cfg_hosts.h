...
public:
    ...
    ///
    /// Used when synchronizing reservations in kea.conf with database.
    ///
...
typedef std::shared_ptr<CfgHosts> CfgHostsPtr;

/// @brief Const pointer.
typedef std::shared_ptr<const CfgHosts> ConstCfgHostsPtr;

...
TEST(CfgSubnets4Test, validLifetimeValidation) {
...

    {
        ...
        data::ElementPtr repr = subnet->toElement();
...

    {
        ...
        data::ElementPtr repr = subnet->toElement();
        data::ElementPtr value = repr->get("valid-lifetime");
        ASSERT_TRUE(value);
...

    {
        ...
        data::ElementPtr min_value = repr->get("min-valid-lifetime");
...

    {
        ...
        ASSERT_TRUE(value);
        EXPECT_EQ("100", value->str());
        data::ElementPtr max_value = repr->get("max-valid-lifetime");

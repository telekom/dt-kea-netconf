...
// This method checks that the DUID-UUID can be created from the
// specified configuration.
TEST_F(CfgDUIDTest, createUUID) {
    CfgDUID cfg;
    ASSERT_NO_THROW(cfg.setType(DUID::DUID_UUID));
    ASSERT_NO_THROW(cfg.setIdentifier("395E4539F13A439EA65A62599102F007"));
    ...
    // Verify if the DUID is correct.
    EXPECT_EQ("00:04:39:5e:45:39:f1:3a:43:9e:a6:5a:62:59:91:02:f0:07", duid->toText());

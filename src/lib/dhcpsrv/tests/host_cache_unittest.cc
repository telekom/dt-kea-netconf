...
typedef std::shared_ptr<TestHostCache> TestHostCachePtr;
...
typedef std::shared_ptr<TestHostDataSource> TestHostDataSourcePtr;
...
typedef std::shared_ptr<TestOneBackend> TestOneBackendPtr;
...
typedef std::shared_ptr<TestNoCache> TestNoCachePtr;

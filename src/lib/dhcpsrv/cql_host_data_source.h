...
/// cases.
struct CqlHostDataSource : BaseHostDataSource {
    /// @brief Constructor
    ///
    ...
    ///        failed.
    explicit CqlHostDataSource(isc::db::DatabaseConnection::ParameterMap const& parameters);
    ...
    /// twice, @ref add() should throw a @ref isc::db::DuplicateEntry exception. Note,
    ...
    ///
    /// @return Collection of const @ref Host objects.
    virtual ConstHostCollection getAll4(const SubnetID& subnet_id) const override final;
    ...
    ///
    /// @return Collection of const @ref Host objects.
    virtual ConstHostCollection getAll6(const SubnetID& subnet_id) const override final;
    ...
    virtual ConstHostCollection getAllbyHostname4(const std::string& hostname,
                                                  const SubnetID& subnet_id) const override;
    ...
    virtual ConstHostCollection getPage4(const SubnetID& subnet_id,
                                         ...
                                         const HostPageSize& page_size) const override final;
...
private:
    ...
    std::shared_ptr<CqlHostDataSourceImpl> impl_;

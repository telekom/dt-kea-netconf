...
typedef std::shared_ptr<SharedNetwork4> SharedNetwork4Ptr;
...
class SharedNetwork4 : public virtual Network4,
                       public std::enable_shared_from_this<SharedNetwork4> {
public:
...
typedef std::shared_ptr<SharedNetwork6> SharedNetwork6Ptr;
...
class SharedNetwork6 : public virtual Network6,
                       public std::enable_shared_from_this<SharedNetwork6> {
public:

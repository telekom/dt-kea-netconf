// File created from ../../../src/lib/dhcpsrv/dhcpsrv_messages.mes on Mon Aug 17 2020 17:11
...
extern const isc::log::MessageID DHCPSRV_CQL_BEGIN_TRANSACTION = "DHCPSRV_CQL_BEGIN_TRANSACTION";
extern const isc::log::MessageID DHCPSRV_CQL_CLEAR_MASTER_CONFIG = "DHCPSRV_CQL_CLEAR_MASTER_CONFIG";
...
extern const isc::log::MessageID DHCPSRV_CQL_DELETE_MASTER_CONFIG = "DHCPSRV_CQL_DELETE_MASTER_CONFIG";
...
extern const isc::log::MessageID DHCPSRV_CQL_GET_MASTER_CONFIG = "DHCPSRV_CQL_GET_MASTER_CONFIG";
extern const isc::log::MessageID DHCPSRV_CQL_GET_MASTER_CONFIG_SHARDS_NAME = "DHCPSRV_CQL_GET_MASTER_CONFIG_SHARDS_NAME";
extern const isc::log::MessageID DHCPSRV_CQL_GET_MASTER_CONFIG_SHARD_DB = "DHCPSRV_CQL_GET_MASTER_CONFIG_SHARD_DB";
extern const isc::log::MessageID DHCPSRV_CQL_GET_MASTER_CONFIG_TIMESTAMP = "DHCPSRV_CQL_GET_MASTER_CONFIG_TIMESTAMP";
extern const isc::log::MessageID DHCPSRV_CQL_GET_MASTER_INSTANCE_IDS = "DHCPSRV_CQL_GET_MASTER_INSTANCE_IDS";
...
extern const isc::log::MessageID DHCPSRV_CQL_GET_SHARD_CONFIG_JSON = "DHCPSRV_CQL_GET_SHARD_CONFIG_JSON";
extern const isc::log::MessageID DHCPSRV_CQL_GET_SHARD_CONFIG_TIMESTAMP = "DHCPSRV_CQL_GET_SHARD_CONFIG_TIMESTAMP";
extern const isc::log::MessageID DHCPSRV_CQL_GET_SUBID4 = "DHCPSRV_CQL_GET_SUBID4";
extern const isc::log::MessageID DHCPSRV_CQL_GET_SUBID6 = "DHCPSRV_CQL_GET_SUBID6";
...
extern const isc::log::MessageID DHCPSRV_CQL_HOST_SYNC_RESERVATIONS = "DHCPSRV_CQL_HOST_SYNC_RESERVATIONS";
extern const isc::log::MessageID DHCPSRV_CQL_INSERT_MASTER_CONFIG = "DHCPSRV_CQL_INSERT_MASTER_CONFIG";
extern const isc::log::MessageID DHCPSRV_CQL_INSERT_SHARD_CONFIG = "DHCPSRV_CQL_INSERT_SHARD_CONFIG";
...
extern const isc::log::MessageID DHCPSRV_CQL_SHARD_CONFIGURATION_DELETE = "DHCPSRV_CQL_SHARD_CONFIGURATION_DELETE";
extern const isc::log::MessageID DHCPSRV_CQL_SUBNET_DB = "DHCPSRV_CQL_SUBNET_DB";
...
extern const isc::log::MessageID DHCPSRV_CQL_UPDATE_SHARD_CONFIG = "DHCPSRV_CQL_UPDATE_SHARD_CONFIG";
extern const isc::log::MessageID DHCPSRV_CQL_UPDATE_SHARD_CONFIG_TIMESTAMP_CHANGED = "DHCPSRV_CQL_UPDATE_SHARD_CONFIG_TIMESTAMP_CHANGED";
...
extern const isc::log::MessageID DHCPSRV_ERROR = "DHCPSRV_ERROR";
...
extern const isc::log::MessageID DHCPSRV_MEMFILE_SUBNET_DB = "DHCPSRV_MEMFILE_SUBNET_DB";
...
extern const isc::log::MessageID DHCPSRV_MYSQL_CLEAR_MASTER_CONFIG = "DHCPSRV_MYSQL_CLEAR_MASTER_CONFIG";
...
extern const isc::log::MessageID DHCPSRV_MYSQL_GET_MASTER_CONFIG = "DHCPSRV_MYSQL_GET_MASTER_CONFIG";
extern const isc::log::MessageID DHCPSRV_MYSQL_GET_MASTER_CONFIG_SHARDS_NAME = "DHCPSRV_MYSQL_GET_MASTER_CONFIG_SHARDS_NAME";
extern const isc::log::MessageID DHCPSRV_MYSQL_GET_MASTER_CONFIG_SHARD_DB = "DHCPSRV_MYSQL_GET_MASTER_CONFIG_SHARD_DB";
extern const isc::log::MessageID DHCPSRV_MYSQL_GET_MASTER_CONFIG_TIMESTAMP = "DHCPSRV_MYSQL_GET_MASTER_CONFIG_TIMESTAMP";
...
extern const isc::log::MessageID DHCPSRV_MYSQL_GET_SHARD_CONFIG_JSON = "DHCPSRV_MYSQL_GET_SHARD_CONFIG_JSON";
extern const isc::log::MessageID DHCPSRV_MYSQL_GET_SHARD_CONFIG_TIMESTAMP = "DHCPSRV_MYSQL_GET_SHARD_CONFIG_TIMESTAMP";
...
extern const isc::log::MessageID DHCPSRV_MYSQL_INSERT_MASTER_CONFIG = "DHCPSRV_MYSQL_INSERT_MASTER_CONFIG";
extern const isc::log::MessageID DHCPSRV_MYSQL_INSERT_SHARD_CONFIG = "DHCPSRV_MYSQL_INSERT_SHARD_CONFIG";
...
extern const isc::log::MessageID DHCPSRV_MYSQL_SUBNET_DB = "DHCPSRV_MYSQL_SUBNET_DB";
...
extern const isc::log::MessageID DHCPSRV_MYSQL_UPDATE_SHARD_CONFIG = "DHCPSRV_MYSQL_UPDATE_SHARD_CONFIG";
extern const isc::log::MessageID DHCPSRV_MYSQL_UPDATE_SHARD_CONFIG_TIMESTAMP_CHANGED = "DHCPSRV_MYSQL_UPDATE_SHARD_CONFIG_TIMESTAMP_CHANGED";
...
extern const isc::log::MessageID DHCPSRV_PGSQL_CLEAR_MASTER_CONFIG = "DHCPSRV_PGSQL_CLEAR_MASTER_CONFIG";
...
extern const isc::log::MessageID DHCPSRV_PGSQL_GET_MASTER_CONFIG = "DHCPSRV_PGSQL_GET_MASTER_CONFIG";
extern const isc::log::MessageID DHCPSRV_PGSQL_GET_MASTER_CONFIG_SHARDS_NAME = "DHCPSRV_PGSQL_GET_MASTER_CONFIG_SHARDS_NAME";
extern const isc::log::MessageID DHCPSRV_PGSQL_GET_MASTER_CONFIG_SHARD_DB = "DHCPSRV_PGSQL_GET_MASTER_CONFIG_SHARD_DB";
extern const isc::log::MessageID DHCPSRV_PGSQL_GET_MASTER_CONFIG_TIMESTAMP = "DHCPSRV_PGSQL_GET_MASTER_CONFIG_TIMESTAMP";
...
extern const isc::log::MessageID DHCPSRV_PGSQL_GET_SHARD_CONFIG_JSON = "DHCPSRV_PGSQL_GET_SHARD_CONFIG_JSON";
extern const isc::log::MessageID DHCPSRV_PGSQL_GET_SHARD_CONFIG_TIMESTAMP = "DHCPSRV_PGSQL_GET_SHARD_CONFIG_TIMESTAMP";
...
extern const isc::log::MessageID DHCPSRV_PGSQL_INSERT_MASTER_CONFIG = "DHCPSRV_PGSQL_INSERT_MASTER_CONFIG";
extern const isc::log::MessageID DHCPSRV_PGSQL_INSERT_SHARD_CONFIG = "DHCPSRV_PGSQL_INSERT_SHARD_CONFIG";
...
extern const isc::log::MessageID DHCPSRV_PGSQL_SUBNET_DB = "DHCPSRV_PGSQL_SUBNET_DB";
...
extern const isc::log::MessageID DHCPSRV_PGSQL_UPDATE_SHARD_CONFIG = "DHCPSRV_PGSQL_UPDATE_SHARD_CONFIG";
extern const isc::log::MessageID DHCPSRV_PGSQL_UPDATE_SHARD_CONFIG_TIMESTAMP_CHANGED = "DHCPSRV_PGSQL_UPDATE_SHARD_CONFIG_TIMESTAMP_CHANGED";
...
const char* values[] = {
    ...
    "DHCPSRV_CQL_CLEAR_MASTER_CONFIG", "Clearing the DHCP master configuration from database",
    ...
    "DHCPSRV_CQL_DELETE_MASTER_CONFIG", "Deleting the DHCP master configuration from database ID %1",
    ...
    "DHCPSRV_CQL_GET_MASTER_CONFIG", "Obtaining the DHCP server configuration from the master database ID %1",
    "DHCPSRV_CQL_GET_MASTER_CONFIG_SHARDS_NAME", "Obtaining the DHCP shards name from the master database",
    "DHCPSRV_CQL_GET_MASTER_CONFIG_SHARD_DB", "Obtaining the DHCP server configuration from the master database for '%1' shard database",
    "DHCPSRV_CQL_GET_MASTER_CONFIG_TIMESTAMP", "Obtaining the DHCP master server configuration's version from database ID %1",
    "DHCPSRV_CQL_GET_MASTER_INSTANCE_IDS", "Obtaining all the instance IDs from the master database",
    ...
    "DHCPSRV_CQL_GET_SHARD_CONFIG_JSON", "Obtaining the DHCP server JSON configuration from database",
    "DHCPSRV_CQL_GET_SHARD_CONFIG_TIMESTAMP", "Obtaining the DHCP server configuration's version from database",
    "DHCPSRV_CQL_GET_SUBID4", "obtaining IPv4 leases for subnet ID %1",
    "DHCPSRV_CQL_GET_SUBID6", "obtaining IPv6 leases for subnet ID %1",
    ...
    "DHCPSRV_CQL_HOST_SYNC_RESERVATIONS", "Syncing reservations in the database with kea.conf.",
    "DHCPSRV_CQL_INSERT_MASTER_CONFIG", "Inserting a new DHCP master server configuration with ID %1 and shard name %2",
    "DHCPSRV_CQL_INSERT_SHARD_CONFIG", "Inserting a new DHCP server configuration with ID %1",
    ...
    "DHCPSRV_CQL_SHARD_CONFIGURATION_DELETE", "Deleting DHCP server configuration with ID %1...",
    "DHCPSRV_CQL_SUBNET_DB", "opening Cassandra subnet database: %1",
    "DHCPSRV_CQL_UPDATE_ADDR4", "updating IPv4 lease for address %1",
    "DHCPSRV_CQL_UPDATE_ADDR6", "updating IPv6 lease for address %1",
    "DHCPSRV_CQL_UPDATE_SHARD_CONFIG", "Updating the DHCP server configuration with ID %1.",
    "DHCPSRV_CQL_UPDATE_SHARD_CONFIG_TIMESTAMP_CHANGED", "Cannot update the DHCP database server configuration (old timestamp is %1, new timestamp is %2)",
    ...
    "DHCPSRV_MEMFILE_SUBNET_DB", "opening memory file subnet database: %1",
    ...
    "DHCPSRV_MYSQL_CLEAR_MASTER_CONFIG", "Clearing the DHCP master configuration from database",
    ...
    "DHCPSRV_MYSQL_GET_MASTER_CONFIG", "Obtaining the DHCP server configuration from the master database ID %1",
    "DHCPSRV_MYSQL_GET_MASTER_CONFIG_SHARDS_NAME", "Obtaining the DHCP shards name from the master database",
    "DHCPSRV_MYSQL_GET_MASTER_CONFIG_SHARD_DB", "Obtaining the DHCP server configuration from the master database for '%1' shard database",
    "DHCPSRV_MYSQL_GET_MASTER_CONFIG_TIMESTAMP", "Obtaining the DHCP master server configuration's version from database ID %1",
    ...
    "DHCPSRV_MYSQL_GET_SHARD_CONFIG_JSON", "Obtaining the DHCP server JSON configuration from database",
    "DHCPSRV_MYSQL_GET_SHARD_CONFIG_TIMESTAMP", "Obtaining the DHCP server configuration's timestamp from database",
    ...
    "DHCPSRV_MYSQL_INSERT_MASTER_CONFIG", "Inserting a new DHCP master server configuration with ID %1 and shard name %2",
    "DHCPSRV_MYSQL_INSERT_SHARD_CONFIG", "Inserting a new DHCP configuration with ID %1",
    ...
    "DHCPSRV_MYSQL_SUBNET_DB", "opening MySQL subnet database: %1",
    ...
    "DHCPSRV_MYSQL_UPDATE_SHARD_CONFIG", "Updating the DHCP server configuration with ID %1.",
    "DHCPSRV_MYSQL_UPDATE_SHARD_CONFIG_TIMESTAMP_CHANGED", "Cannot update the DHCP database server configuration (old timestamp is %1, new timestamp is %2)",
    ...
    "DHCPSRV_PGSQL_CLEAR_MASTER_CONFIG", "Clearing the DHCP master configuration from database",
    ...
    "DHCPSRV_PGSQL_GET_MASTER_CONFIG", "Obtaining the DHCP server configuration from the master database ID %1",
    "DHCPSRV_PGSQL_GET_MASTER_CONFIG_SHARDS_NAME", "Obtaining the DHCP shards name from the master database",
    "DHCPSRV_PGSQL_GET_MASTER_CONFIG_SHARD_DB", "Obtaining the DHCP shard configuration from the master database for '%1' shard database",
    "DHCPSRV_PGSQL_GET_MASTER_CONFIG_TIMESTAMP", "Obtaining the DHCP master server configuration's version from database ID %1",
    ...
    "DHCPSRV_PGSQL_GET_SHARD_CONFIG_JSON", "Obtaining the DHCP server JSON configuration from database",
    "DHCPSRV_PGSQL_GET_SHARD_CONFIG_TIMESTAMP", "Obtaining the DHCP server configuration's version from database",
    ...
    "DHCPSRV_PGSQL_INSERT_MASTER_CONFIG", "Inserting a new DHCP master server configuration with ID %1 and shard name %2",
    "DHCPSRV_PGSQL_INSERT_SHARD_CONFIG", "Inserting a new DHCP server configuration with ID %1",
    ...
    "DHCPSRV_PGSQL_SUBNET_DB", "opening PostgreSQL subnet database: %1",
    ...
    "DHCPSRV_PGSQL_UPDATE_SHARD_CONFIG", "Updating the DHCP server configuration with ID %1.",
    "DHCPSRV_PGSQL_UPDATE_SHARD_CONFIG_TIMESTAMP_CHANGED", "Cannot update the DHCP database server configuration (old timestamp is %1, new timestamp is %2)",

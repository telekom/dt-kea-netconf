...
template <>
bool LeaseMgr::lock<DHCP_SPACE_V4>(std::vector<uint8_t>& lock_key) {
    return lock4(lock_key);
}

template <>
bool LeaseMgr::lock<DHCP_SPACE_V6>(std::vector<uint8_t>& lock_key) {
    return lock6(lock_key);
}

template <>
bool LeaseMgr::unlock<DHCP_SPACE_V4>(std::vector<uint8_t>& lock_key) {
    return unlock4(lock_key);
}

template <>
bool LeaseMgr::unlock<DHCP_SPACE_V6>(std::vector<uint8_t>& lock_key) {
    return unlock6(lock_key);
}

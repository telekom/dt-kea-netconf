...
OptionDescriptor::create(const OptionPtr& opt, bool persist,
    ...
    return (std::make_shared<OptionDescriptor>(opt, persist, formatted_value,
                                                 user_context));
}

OptionDescriptorPtr
OptionDescriptor::create(bool persist) {
    return (std::make_shared<OptionDescriptor>(persist));
}

OptionDescriptorPtr
OptionDescriptor::create(const OptionDescriptor& desc) {
    return (std::make_shared<OptionDescriptor>(desc));
}

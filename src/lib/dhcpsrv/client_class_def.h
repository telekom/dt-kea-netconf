...
typedef std::shared_ptr<ClientClassDef> ClientClassDefPtr;
...
typedef std::shared_ptr<ClientClassDefMap> ClientClassDefMapPtr;
...
typedef std::shared_ptr<ClientClassDefList> ClientClassDefListPtr;
...
public:
    ...
    void addClass(const std::string& name, const ExpressionPtr& match_expr,
                  ...
                  isc::data::ElementPtr user_context = isc::data::ElementPtr(),
...
typedef std::shared_ptr<ClientClassDictionary> ClientClassDictionaryPtr;

...
OptionDefinition::create(const std::string& name,
    ...
    return (std::make_shared<OptionDefinition>(name, code, type, array_type));
}
...
OptionDefinition::create(const std::string& name,
                         ...
                         const std::string& type,
                         const char* encapsulated_space) {
    return (std::make_shared<OptionDefinition>(name, code, type, encapsulated_space));
}
...
OptionDefinition::factoryAddrList4(uint16_t type,
    ...
    std::shared_ptr<Option4AddrLst> option(new Option4AddrLst(type, begin,
                                                                end));
    return (option);
}
...
OptionDefinition::factoryAddrList6(uint16_t type,
                                   OptionBufferConstIter begin,
                                   OptionBufferConstIter end) {
    std::shared_ptr<Option6AddrLst> option(new Option6AddrLst(type, begin,
                                                                end));
    return (option);
}
...
OptionDefinition::factoryIA6(uint16_t type,
    ...
    std::shared_ptr<Option6IA> option(new Option6IA(type, begin, end));
    return (option);
}
...
OptionDefinition::factoryIAAddr6(uint16_t type,
    ...
    std::shared_ptr<Option6IAAddr> option(new Option6IAAddr(type, begin,
                                                              end));
    return (option);
}
...
OptionDefinition::factoryIAPrefix6(uint16_t type,
    ...
    std::shared_ptr<Option6IAPrefix> option(new Option6IAPrefix(type, begin,
                                                                  end));
    return (option);
}
...
OptionDefinition::factoryOpaqueDataTuples(Option::Universe u,
                                          ...
                                          OptionBufferConstIter begin,
                                          OptionBufferConstIter end) {
    std::shared_ptr<OptionOpaqueDataTuples>

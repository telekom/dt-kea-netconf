...
TEST_F(OptionTest, v6_basic) {
    ...
    unique_ptr<Option> opt(new Option(Option::V6, 1));
...
TEST_F(OptionTest, v6_data1) {
    ...
    unique_ptr<Option> opt(new Option(Option::V6, 333,   // Type
...
TEST_F(OptionTest, v6_data2) {
    ...
    unique_ptr<Option> opt(new Option(Option::V6, D6O_CLIENTID,
...
TEST_F(OptionTest, v6_suboptions1) {
    ...
    unique_ptr<Option> opt1(new Option(Option::V6, 65535, // Type
...
TEST_F(OptionTest, v6_addgetdel) {
    ...
    unique_ptr<Option> parent(new Option(Option::V6, 65535)); // Type

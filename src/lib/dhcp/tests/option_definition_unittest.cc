...
TEST_F(OptionDefinitionTest, ipv6AddressArray) {
    ...
    std::shared_ptr<Option6AddrLst> option_cast_v6 =
        std::static_pointer_cast<Option6AddrLst>(option_v6);
...
TEST_F(OptionDefinitionTest, ipv4AddressArray) {
    ...
    // Get the list of parsed addresses from the option object.
    std::shared_ptr<Option4AddrLst> option_cast_v4 =
        std::static_pointer_cast<Option4AddrLst>(option_v4);
    std::vector<asiolink::IOAddress> addrs_returned =
...
TEST_F(OptionDefinitionTest, recordIA6) {
    ...
    std::shared_ptr<Option6IA> option_cast_v6 =
        std::static_pointer_cast<Option6IA>(option_v6);
...
TEST_F(OptionDefinitionTest, recordIAAddr6) {
    ...
    std::shared_ptr<Option6IAAddr> option_cast_v6 =
        std::static_pointer_cast<Option6IAAddr>(option_v6);
...
TEST_F(OptionDefinitionTest, boolValue) {
    ...
    std::shared_ptr<OptionCustom> option_cast_v4 =
        std::static_pointer_cast<OptionCustom>(option_v4);
    ...
    option_cast_v4 = std::static_pointer_cast<OptionCustom>(option_v4);
...
TEST_F(OptionDefinitionTest, uint8) {
    ...
    // Validate the value.
    std::shared_ptr<OptionInt<uint8_t> > option_cast_v6 =
        std::static_pointer_cast<OptionInt<uint8_t> >(option_v6);
...
TEST_F(OptionDefinitionTest, uint16) {
    ...
    // Validate the value.
    std::shared_ptr<OptionInt<uint16_t> > option_cast_v6 =
        std::static_pointer_cast<OptionInt<uint16_t> >(option_v6);
...
TEST_F(OptionDefinitionTest, uint32) {
    ...
    // Validate the value.
    std::shared_ptr<OptionInt<uint32_t> > option_cast_v6 =
        std::static_pointer_cast<OptionInt<uint32_t> >(option_v6);
...
TEST_F(OptionDefinitionTest, uint16Array) {
    ...
    std::shared_ptr<OptionIntArray<uint16_t> > option_cast_v6 =
        std::static_pointer_cast<OptionIntArray<uint16_t> >(option_v6);
...
TEST_F(OptionDefinitionTest, uint32Array) {
    ...
    std::shared_ptr<OptionIntArray<uint32_t> > option_cast_v6 =
        std::static_pointer_cast<OptionIntArray<uint32_t> >(option_v6);
    // Get the values from the initiated options and validate.
...
TEST_F(OptionDefinitionTest, utf8StringTokenized) {
    ...
    OptionStringPtr option_v6_string =
        std::static_pointer_cast<OptionString>(option_v6);
...
TEST_F(OptionDefinitionTest, prefix) {
    ...
    OptionCustomPtr option_cast_v6 =
        std::dynamic_pointer_cast<OptionCustom>(option_v6);
...
TEST_F(OptionDefinitionTest, tuple4ArrayTokenized) {
    ...
    OptionOpaqueDataTuplesPtr option_cast =
        std::dynamic_pointer_cast<OptionOpaqueDataTuples>(option);

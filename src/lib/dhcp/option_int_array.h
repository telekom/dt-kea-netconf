...
typedef std::shared_ptr<OptionUint8Array> OptionUint8ArrayPtr;
typedef OptionIntArray<uint16_t> OptionUint16Array;
typedef std::shared_ptr<OptionUint16Array> OptionUint16ArrayPtr;
typedef OptionIntArray<uint32_t> OptionUint32Array;
typedef std::shared_ptr<OptionUint32Array> OptionUint32ArrayPtr;
/// @}
...
private:
    ...
    typedef std::shared_ptr<OptionIntArray<T> > OptionIntArrayTypePtr;

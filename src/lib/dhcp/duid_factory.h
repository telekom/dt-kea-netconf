...
public:
    ...
    /// @brief Generates DUID-UUID.
    ///
    /// This method generates DUID-UUID (Universally Unique IDentifier).
    ///
    /// @param identifier Data to be used as UUID value.
    void createUUID(const std::vector<uint8_t>& identifier);

...
public:
    ...
    typedef std::function<isc::data::ElementPtr (const std::string& name,
        const isc::data::ElementPtr& params)> CommandHandler;
    ...
    typedef std::function<isc::data::ElementPtr (const std::string& name,
        ...
        const isc::data::ElementPtr& original)> ExtendedCommandHandler;
    ...
    /// format.
    isc::data::ElementPtr
    processCommand(const isc::data::ElementPtr& cmd);

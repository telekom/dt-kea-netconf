...
protected:
    ...
    void setSuccessResponse(hooks::CalloutHandle& handle, const std::string& text) {
        data::ElementPtr response = createAnswer(CONTROL_RESULT_SUCCESS, text);
    ...
    void setErrorResponse(hooks::CalloutHandle& handle, const std::string& text,
        ...
        data::ElementPtr response = createAnswer(status, text);
        setResponse (handle, response);
    }
    ...
    void setResponse(hooks::CalloutHandle& handle, data::ElementPtr& response) {

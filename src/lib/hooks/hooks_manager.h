...
public:
    ...
    static std::shared_ptr<CalloutHandle> createCalloutHandle();
...
private:
    ...
    ///
    /// @return Shared pointer to a CalloutHandle object.
    std::shared_ptr<CalloutHandle> createCalloutHandleInternal();
    ...
    ///
    /// @node: This should never be null.
    std::shared_ptr<CalloutManager> callout_manager_;

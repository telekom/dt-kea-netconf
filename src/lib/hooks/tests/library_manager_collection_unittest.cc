...
TEST_F(LibraryManagerCollectionTest, LoadLibraries) {
    ...
    library_names.push_back({std::string(FULL_CALLOUT_LIBRARY), "parameters",
                                      data::ElementPtr()});
    library_names.push_back({std::string(BASIC_CALLOUT_LIBRARY), "parameters",
                                      data::ElementPtr()});
    ...
    std::shared_ptr<CalloutManager> manager =
...
TEST_F(LibraryManagerCollectionTest, LoadLibrariesWithError) {
    ...
    library_names.push_back({std::string(FULL_CALLOUT_LIBRARY), "parameters",
                                       data::ElementPtr()});
    library_names.push_back({std::string(INCORRECT_VERSION_LIBRARY), "parameters",
                                      data::ElementPtr()});
    library_names.push_back({std::string(BASIC_CALLOUT_LIBRARY), "parameters",
                                      data::ElementPtr()});
...
TEST_F(LibraryManagerCollectionTest, LibraryNames) {
    ...
    libraries.push_back({std::string(FULL_CALLOUT_LIBRARY), "parameters",
                                  data::ElementPtr()});
    libraries.push_back({std::string(BASIC_CALLOUT_LIBRARY), "parameters",
                                  data::ElementPtr()});
...
TEST_F(LibraryManagerCollectionTest, libraryGetEmpty) {
    ...
    std::shared_ptr<LibraryManagerCollection> mgr;
...
TEST_F(LibraryManagerCollectionTest, libraryGet) {
    ...
    libs.push_back({"libone", "parameters", param1});
    libs.push_back({"libtwo", "parameters", param2});

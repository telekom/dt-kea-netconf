...
int load(LibraryHandle& handle) {
    ElementPtr elems        = handle.getParameters();
    ElementPtr string_elem  = handle.getParameter("svalue");
    ElementPtr int_elem     = handle.getParameter("ivalue");
    ElementPtr bool_elem    = handle.getParameter("bvalue");
    ElementPtr nonexistent  = handle.getParameter("nonexistent");

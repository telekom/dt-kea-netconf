...
public:
    ...
    void add(std::string const& library_name,
             std::string const& parameters_key,
             isc::data::ElementPtr parameters_value) {
        libraries_.push_back({library_name, parameters_key, parameters_value});
    }
    ...
    void verifyLibraries(isc::data::Element::Position& position) const;

...
bool checkIAStatus(std::shared_ptr<Option6IA>& ia_opt);
...
std::string getAddrStrIA_NA(OptionPtr options) {
    std::shared_ptr<Option6IA> ia =
        std::dynamic_pointer_cast<Option6IA>(options);
    ...
    std::shared_ptr<Option6IAAddr> addr_option;
    addr_option  = std::dynamic_pointer_cast<Option6IAAddr>(options);
    if (!addr_option) {
...
std::string getAddrStrIA_PD(OptionPtr options) {
    ...
    std::shared_ptr<Option6IAPrefix> addr_option;
    addr_option = std::dynamic_pointer_cast<Option6IAPrefix>(options);
    if (!addr_option) {
...
bool checkIAStatus(std::shared_ptr<Option6IA>& ia) {

...
protected:
    ...
    std::shared_ptr<MySqlConfigBackendImpl> base_impl_;

    /// @brief Pointer to the implementation of the @c MySqlConfigBackendDHCPv6
    /// class.
    std::shared_ptr<MySqlConfigBackendDHCPv6Impl> impl_;

};

/// @brief Pointer to the @c MySqlConfigBackendDHCPv6 class.
typedef std::shared_ptr<MySqlConfigBackendDHCPv6> MySqlConfigBackendDHCPv6Ptr;

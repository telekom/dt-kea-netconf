...
public:
    ...
    typedef std::shared_ptr<OptionConfig> OptionConfigPtr;
    ...
    void configure(isc::data::ElementPtr options);
...
private:
    ...
    void parseOptionConfig(isc::data::ElementPtr option);

};

/// @brief The type of shared pointers to Flex Option implementations.
typedef std::shared_ptr<FlexOptionImpl> FlexOptionImplPtr;

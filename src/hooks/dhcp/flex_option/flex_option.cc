...
void
FlexOptionImpl::configure(ElementPtr options) {
    if (!options) {
...
void
FlexOptionImpl::parseOptionConfig(ElementPtr option) {
    ...
    ElementPtr code_elem = option->get("code");
    ElementPtr name_elem = option->get("name");

...
public:
    ...
    void testCommand(string cmd_txt, int exp_result, string exp_txt,
        ...
        ElementPtr actual_args = rsp->get("arguments");
        ...
        ElementPtr exp_result_set = exp_args->get("result-set");
        ...
        ElementPtr actual_result_set = actual_args->get("result-set");
    ...
    std::string toJSON(ElementPtr element) {
        std::stringstream os;
        element->toJSON(os);
        return (os.str());
    }

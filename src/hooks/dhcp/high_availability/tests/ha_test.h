...
typedef std::shared_ptr<NakedCommunicationState4> NakedCommunicationState4Ptr;
...
typedef std::shared_ptr<NakedCommunicationState6> NakedCommunicationState6Ptr;
...
public:
    ...
    std::shared_ptr<std::thread> runIOServiceInThread();
...
public:
    ...
    void checkAnswer(const isc::data::ElementPtr& answer,

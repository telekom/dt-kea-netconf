...
/// provided command.
void
testCommandBasics(const ElementPtr& command,
    ...
    ElementPtr command_name = command->get("command");
    ...
    // entry.
    ElementPtr service = command->get("service");
    ASSERT_TRUE(service);
    ...
    ElementPtr command_arguments = command->get("arguments");
...
TEST(CommandCreatorTest, createDHCPDisable4) {
    ...
    ElementPtr command = CommandCreator::createDHCPDisable(20, HAServerType::DHCPv4);
    ElementPtr arguments;
    ASSERT_NO_FATAL_FAILURE(testCommandBasics(command, "dhcp-disable", "dhcp4",
                                              arguments));
    ElementPtr max_period = arguments->get("max-period");
...
TEST(CommandCreatorTest, createDHCPEnable4) {
    ElementPtr command = CommandCreator::createDHCPEnable(HAServerType::DHCPv4);
...
TEST(CommandCreatorTest, createHeartbeat4) {
    ElementPtr command = CommandCreator::createHeartbeat(HAServerType::DHCPv4);
...
TEST(CommandCreatorTest, createLease4Update) {
    ElementPtr command = CommandCreator::createLease4Update(*createLease4());
    ElementPtr arguments;
...
TEST(CommandCreatorTest, createLease4Delete) {
    ElementPtr command = CommandCreator::createLease4Delete(*createLease4());
    ElementPtr arguments;
...
TEST(CommandCreatorTest, createLease4GetAll) {
    ElementPtr command = CommandCreator::createLease4GetAll();
...
TEST(CommandCreatorTest, createLease4GetPageAddress) {
    ...
    ElementPtr command = CommandCreator::createLease4GetPage(lease4, 15);
    ElementPtr arguments;
    ASSERT_NO_FATAL_FAILURE(testCommandBasics(command, "lease4-get-page", "dhcp4",
                                              arguments));
...
TEST(CommandCreatorTest, createDHCPDisable6) {
    // Create command with max-period value set to 20.
    ElementPtr command = CommandCreator::createDHCPDisable(20, HAServerType::DHCPv6);
    ElementPtr arguments;
...
TEST(CommandCreatorTest, createDHCPEnable6) {
    ElementPtr command = CommandCreator::createDHCPEnable(HAServerType::DHCPv6);
    ASSERT_NO_FATAL_FAILURE(testCommandBasics(command, "dhcp-enable", "dhcp6"));
}

TEST(CommandCreatorTest, createLease6Update) {
    ElementPtr command = CommandCreator::createLease6Update(*createLease6());
    ElementPtr arguments;
...
TEST(CommandCreatorTest, createLease6Delete) {
    ElementPtr command = CommandCreator::createLease6Delete(*createLease6());
    ElementPtr arguments;
...
TEST(CommandCreatorTest, createLease6BulkApply) {
    ...
    ElementPtr command = CommandCreator::createLease6BulkApply(leases, deleted_leases);
    ElementPtr arguments;
...
TEST(CommandCreatorTest, createLease6GetAll) {
    ElementPtr command = CommandCreator::createLease6GetAll();
...
TEST(CommandCreatorTest, createLease6GetPageStart) {
    Lease6Ptr lease6;
    ElementPtr command = CommandCreator::createLease6GetPage(lease6, 10);
    ElementPtr arguments;
...
TEST(CommandCreatorTest, createLease6GetPageAddress) {
    ...
    ElementPtr command = CommandCreator::createLease6GetPage(lease6, 15);
    ElementPtr arguments;
    ASSERT_NO_FATAL_FAILURE(testCommandBasics(command, "lease6-get-page", "dhcp6",
                                              arguments));
...
TEST(CommandCreatorTest, createMaintenanceNotify4) {
    ElementPtr command = CommandCreator::createMaintenanceNotify(true, HAServerType::DHCPv4);
    ElementPtr arguments;
...
TEST(CommandCreatorTest, createMaintenanceNotify6) {
    ElementPtr command = CommandCreator::createMaintenanceNotify(false, HAServerType::DHCPv6);
    ElementPtr arguments;

...
public:
    ...
    typedef std::shared_ptr<PeerConfig> PeerConfigPtr;
    ...
    typedef std::shared_ptr<StateConfig> StateConfigPtr;
    ...
    typedef std::shared_ptr<StateMachineConfig> StateMachineConfigPtr;
...
typedef std::shared_ptr<HAConfig> HAConfigPtr;
